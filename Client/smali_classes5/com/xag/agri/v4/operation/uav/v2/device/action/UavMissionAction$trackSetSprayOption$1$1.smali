.class final Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1;->invoke()V
.end annotation
...
.method public constructor <init>(Lcom/xag/agri/device/sdk/devices/uav/Uav;DIDI)V
    ...
    iput-object p1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$this_trackSetSprayOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;

    iput-wide p2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$dosage:D

    iput p4, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$atom:I

    iput-wide p5, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$flow:D

    iput p7, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$particle:I
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->invoke()V
...
.method public final invoke()V
    ...
    iget-object v1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$this_trackSetSprayOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;
    ...
    .line 3
    iget-object v0, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$this_trackSetSprayOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;
    ...
    iget v3, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$atom:I

    iget-wide v4, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$flow:D

    iget-wide v6, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$dosage:D

    iget v8, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$particle:I
    ...
    invoke-virtual {v9, v3}, Lcom/xag/agri/device/sdk/devices/uav/thing/action/model/UavRemoteControlParam$Spray;->setDroplet(Ljava/lang/Integer;)V
    ...
    invoke-virtual {v3, v4}, Lcom/xag/agri/device/sdk/devices/uav/thing/action/model/UavRemoteControlParam$Spray;->setDosage(Ljava/lang/Double;)V
    ...
    iget-wide v2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$flow:D

    iget v4, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$atom:I

    iget-wide v5, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$dosage:D

    iget v7, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$particle:I
    ...
    iget-wide v2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$dosage:D
    ...
    iget v2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$atom:I
    ...
    iget-wide v1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetSprayOption$1$1;->$flow:D
