.class final Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1;->invoke()V
.end annotation
...
.field final synthetic $this_trackSetHomeOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;
...
.method public constructor <init>(Lcom/xag/agri/device/sdk/devices/uav/Uav;DD)V
    ...
    iput-object p1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$this_trackSetHomeOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;

    iput-wide p2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$height:D

    iput-wide p4, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$speed:D
...
.method public bridge synthetic invoke()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->invoke()V
...
.method public final invoke()V
    ...
    iget-object v1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$this_trackSetHomeOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;
    ...
    .line 3
    iget-object v0, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$this_trackSetHomeOption:Lcom/xag/agri/device/sdk/devices/uav/Uav;
    ...
    iget-wide v3, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$speed:D

    iget-wide v5, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$height:D
    ...
    invoke-virtual {v2, v3}, Lcom/xag/agri/device/sdk/devices/uav/thing/action/model/UavRemoteControlParam;->setHomeSpeed(Ljava/lang/Double;)V
    ...
    invoke-virtual {v2, v3}, Lcom/xag/agri/device/sdk/devices/uav/thing/action/model/UavRemoteControlParam;->setHomeHeight(Ljava/lang/Double;)V
    ...
    iget-wide v2, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$speed:D

    iget-wide v4, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$height:D
    ...
    iget-wide v1, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$height:D

    iget-wide v3, p0, Lcom/xag/agri/v4/operation/uav/v2/device/action/UavMissionAction$trackSetHomeOption$1$1;->$speed:D

    invoke-virtual {v0, v1, v2, v3, v4}, Lap/b;->G(DD)V
