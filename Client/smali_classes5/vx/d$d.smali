...
.method public constructor <init>(Lvx/d;Landroidx/room/RoomDatabase;)V
    ...
    .line 1
    iput-object p1, p0, Lvx/d$d;->a:Lvx/d;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Lvx/d$d;->a(Landroidx/sqlite/db/SupportSQLiteStatement;Lwx/b;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `mission_progresses` SET `id` = ?,`mission_guid` = ?,`lat` = ?,`lng` = ?,`alt` = ?,`create_at` = ?,`update_at` = ?,`current_waypoint_index` = ?,`mission_status` = ?,`progress` = ?,`progress_area_size` = ?,`total_area_size` = ?,`progress_length` = ?,`total_length` = ?,`total_waypoint_count` = ?,`break_state` = ?,`break_event` = ?,`break_occur_time` = ?,`break_wp_index` = ?,`break_latitude` = ?,`break_longitude` = ?,`break_altitude` = ? WHERE `id` = ?"
