...
.method public constructor <init>(Ljava/security/KeyPair;Ljava/security/PublicKey;)V
    ...
    invoke-direct {p0, v0, p1, p2, v1}, Lgp0/n;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/KeyPair;Ljava/security/PublicKey;[B)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Lgp0/n;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PrivateKey;Ljava/security/PublicKey;)V
    ...
    invoke-direct {p0, v0, p1, p2, v0}, Lgp0/n;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lgp0/n;-><init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
...
.method public constructor <init>(Ljava/security/PublicKey;Ljava/security/PrivateKey;Ljava/security/PublicKey;[B)V
    ...
    iput-object p1, p0, Lgp0/n;->a:Ljava/security/PublicKey;

    iput-object p2, p0, Lgp0/n;->b:Ljava/security/PrivateKey;

    iput-object p3, p0, Lgp0/n;->c:Ljava/security/PublicKey;

    invoke-static {p4}, Lorg/bouncycastle/util/a;->p([B)[B

    move-result-object p1

    iput-object p1, p0, Lgp0/n;->d:[B
...
.method public a()Ljava/security/PrivateKey;
    ...
    .line 1
    iget-object v0, p0, Lgp0/n;->b:Ljava/security/PrivateKey;
...
.method public b()Ljava/security/PublicKey;
    ...
    .line 1
    iget-object v0, p0, Lgp0/n;->a:Ljava/security/PublicKey;
...
.method public c()Ljava/security/PublicKey;
    ...
    .line 1
    iget-object v0, p0, Lgp0/n;->c:Ljava/security/PublicKey;
