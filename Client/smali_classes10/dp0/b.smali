...
.method public constructor <init>(Lorg/bouncycastle/jcajce/util/d;)V
    ...
    iput-object v0, p0, Ldp0/b;->a:Ljava/util/Hashtable;

    iput-object p1, p0, Ldp0/b;->b:Lorg/bouncycastle/jcajce/util/d;
...
# virtual methods
.method public final a(Lorg/bouncycastle/crypto/s;[C)V
    .locals 3
    ...
    invoke-interface {p1, v2}, Lorg/bouncycastle/crypto/s;->update(B)V
...
.method public final b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    .line 1
    iget-object v0, p0, Ldp0/b;->b:Lorg/bouncycastle/jcajce/util/d;

    if-eqz v0, :cond_0

    :try_start_0
    invoke-interface {v0, p1}, Lorg/bouncycastle/jcajce/util/d;->p(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
...
.method public final c(Ljava/io/InputStream;[C)Ldp0/b$b;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, v0, p2}, Ldp0/b;->a(Lorg/bouncycastle/crypto/s;[C)V
    ...
    invoke-interface {v0, p1, v1, p2}, Lorg/bouncycastle/crypto/s;->update([BII)V
    ...
    invoke-interface {v0, v2, v1}, Lorg/bouncycastle/crypto/s;->c([BI)I
    ...
    invoke-direct {v0, p1, v1, v2}, Ldp0/b$b;-><init>([BII)V
    ...
    invoke-direct {p2, p1, v1, v2}, Ldp0/b$b;-><init>([BII)V
...
.method public engineAliases()Ljava/util/Enumeration;
    ...
    iget-object v0, p0, Ldp0/b;->a:Ljava/util/Hashtable;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Ldp0/b;->a:Ljava/util/Hashtable;
...
.method public engineGetCertificate(Ljava/lang/String;)Ljava/security/cert/Certificate;
    ...
    iget-object p1, p1, Ldp0/b$a;->b:Ljava/security/cert/Certificate;
...
.method public engineGetCertificateAlias(Ljava/security/cert/Certificate;)Ljava/lang/String;
    ...
    check-cast v3, Ldp0/b$a;

    iget-object v3, v3, Ldp0/b$a;->b:Ljava/security/cert/Certificate;
...
.method public engineGetCreationDate(Ljava/lang/String;)Ljava/util/Date;
    ...
    iget-object p1, p1, Ldp0/b$a;->a:Ljava/util/Date;
...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    :cond_0
    invoke-virtual/range {p0 .. p2}, Ldp0/b;->c(Ljava/io/InputStream;[C)Ldp0/b$b;

    move-result-object v2

    iget-object v3, v1, Ldp0/b;->a:Ljava/util/Hashtable;
    ...
    invoke-virtual {v1, v8}, Ldp0/b;->b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    :cond_3
    invoke-virtual {v1, v4}, Ldp0/b;->b(Ljava/lang/String;)Ljava/security/cert/CertificateFactory;
    ...
    new-instance v6, Ldp0/b$b;

    invoke-direct {v6, v15, v10, v14}, Ldp0/b$b;-><init>([BII)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_2
    invoke-virtual {v6}, Ldp0/b$b;->a()V

    iget-object v6, v1, Ldp0/b;->a:Ljava/util/Hashtable;

    new-instance v15, Ldp0/b$a;

    invoke-direct {v15, v13, v14}, Ldp0/b$a;-><init>(Ljava/util/Date;Ljava/security/cert/Certificate;)V
    ...
    :try_start_5
    invoke-virtual {v2}, Ldp0/b$b;->a()V
...
.method public engineLoad(Ljava/security/KeyStore$LoadStoreParameter;)V
    ...
    invoke-virtual {p0, p1, p1}, Ldp0/b;->engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-virtual {p0, v0, p1}, Ldp0/b;->engineLoad(Ljava/io/InputStream;[C)V
