...
.field public i:Lorg/bouncycastle/crypto/k;

.field public j:Lzn0/g1;

.field public k:[B

.field public l:Lrn0/u;

.field public m:Lorg/bouncycastle/crypto/z;

.field public n:[B


# direct methods
.method public constructor <init>(Lorg/bouncycastle/crypto/e;Lorg/bouncycastle/crypto/q;Lorg/bouncycastle/crypto/a0;[B)V
    .locals 0

    .line 1
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lon0/y;->a:Lorg/bouncycastle/crypto/e;

    iput-object p2, p0, Lon0/y;->b:Lorg/bouncycastle/crypto/q;

    iput-object p3, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    iput-object p1, p0, Lon0/y;->e:[B

    iput-object p4, p0, Lon0/y;->f:[B

    const/4 p1, 0x0

    iput-object p1, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;

    return-void
.end method

.method public constructor <init>(Lorg/bouncycastle/crypto/e;Lorg/bouncycastle/crypto/q;Lorg/bouncycastle/crypto/a0;[BLorg/bouncycastle/crypto/h;)V
    .locals 0
    ...
    iput-object p5, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;
...
.method public final a([BII)[B
    ...
    .line 1
    iget-object v0, p0, Lon0/y;->k:[B

    array-length v0, v0

    iget-object v1, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    iget-object v0, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;
    ...
    iget-object v2, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    iget-object v3, p0, Lon0/y;->j:Lzn0/g1;
    ...
    iget-object v7, p0, Lon0/y;->b:Lorg/bouncycastle/crypto/q;

    invoke-interface {v7, v6, v1, v5}, Lorg/bouncycastle/crypto/q;->c([BII)I

    iget-object v5, p0, Lon0/y;->k:[B
    ...
    :cond_2
    iget-object v0, p0, Lon0/y;->j:Lzn0/g1;
    ...
    :cond_3
    iget-object v2, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;

    invoke-virtual {v2, v1, v0}, Lorg/bouncycastle/crypto/h;->f(ZLorg/bouncycastle/crypto/k;)V

    iget-object v0, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;

    iget-object v2, p0, Lon0/y;->k:[B

    array-length v2, v2

    sub-int v2, p3, v2

    iget-object v3, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    iget-object v5, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;
    ...
    :goto_2
    iget-object v2, p0, Lon0/y;->j:Lzn0/g1;
    ...
    invoke-virtual {p0, v2}, Lon0/y;->e([B)[B
    ...
    iget-object v7, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    new-instance v9, Lln0/e0;

    invoke-direct {v9}, Lln0/e0;-><init>()V

    invoke-interface {v9}, Lorg/bouncycastle/crypto/s;->f()I

    move-result v10

    new-array v10, v10, [B

    invoke-interface {v9}, Lorg/bouncycastle/crypto/s;->reset()V

    array-length v11, v4

    invoke-interface {v9, v4, v1, v11}, Lorg/bouncycastle/crypto/s;->update([BII)V

    invoke-interface {v9, v10, v1}, Lorg/bouncycastle/crypto/s;->c([BI)I

    iget-object v4, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;

    new-instance v9, Lzn0/n1;

    invoke-direct {v9, v10}, Lzn0/n1;-><init>([B)V

    invoke-interface {v4, v9}, Lorg/bouncycastle/crypto/a0;->a(Lorg/bouncycastle/crypto/k;)V

    iget-object v4, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;

    iget-object v9, p0, Lon0/y;->n:[B

    array-length v10, v9

    invoke-interface {v4, v9, v1, v10}, Lorg/bouncycastle/crypto/a0;->update([BII)V

    iget-object v4, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;

    iget-object v9, p0, Lon0/y;->k:[B
    ...
    iget-object p1, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    iget-object p2, p0, Lon0/y;->f:[B

    array-length p3, p2

    invoke-interface {p1, p2, v1, p3}, Lorg/bouncycastle/crypto/a0;->update([BII)V
    ...
    iget-object p1, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;
...
.method public final b([BII)[B
    ...
    iget-object v6, p0, Lon0/y;->b:Lorg/bouncycastle/crypto/q;

    invoke-interface {v6, v5, v1, v4}, Lorg/bouncycastle/crypto/q;->c([BII)I

    iget-object v4, p0, Lon0/y;->k:[B
    ...
    iget-object p2, p0, Lon0/y;->d:Lorg/bouncycastle/crypto/h;
    ...
    :cond_3
    iget-object p1, p0, Lon0/y;->j:Lzn0/g1;

    invoke-virtual {p1}, Lzn0/g1;->b()[B

    move-result-object p1

    iget-object p2, p0, Lon0/y;->k:[B

    array-length p2, p2

    if-eqz p2, :cond_4

    invoke-virtual {p0, p1}, Lon0/y;->e([B)[B
    ...
    :goto_4
    iget-object v0, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;
    ...
    new-instance v5, Lln0/e0;

    invoke-direct {v5}, Lln0/e0;-><init>()V
    ...
    invoke-interface {v5, v3, v1, v7}, Lorg/bouncycastle/crypto/s;->update([BII)V

    invoke-interface {v5, v6, v1}, Lorg/bouncycastle/crypto/s;->c([BI)I
    ...
    invoke-interface {v3, v5}, Lorg/bouncycastle/crypto/a0;->a(Lorg/bouncycastle/crypto/k;)V

    iget-object v3, p0, Lon0/y;->c:Lorg/bouncycastle/crypto/a0;

    iget-object v5, p0, Lon0/y;->n:[B

    array-length v6, v5

    invoke-interface {v3, v5, v1, v6}, Lorg/bouncycastle/crypto/a0;->update([BII)V
...
.method public final c(Lorg/bouncycastle/crypto/k;)V
    ...
    iput-object p1, p0, Lon0/y;->j:Lzn0/g1;
...
.method public g(Lzn0/c;Lorg/bouncycastle/crypto/k;Lorg/bouncycastle/crypto/z;)V
    ...
    iput-boolean v0, p0, Lon0/y;->g:Z

    iput-object p1, p0, Lon0/y;->h:Lorg/bouncycastle/crypto/k;

    iput-object p3, p0, Lon0/y;->m:Lorg/bouncycastle/crypto/z;

    invoke-virtual {p0, p2}, Lon0/y;->c(Lorg/bouncycastle/crypto/k;)V
...
.method public h(Lzn0/c;Lorg/bouncycastle/crypto/k;Lrn0/u;)V
    ...
    iput-object p1, p0, Lon0/y;->i:Lorg/bouncycastle/crypto/k;

    iput-object p3, p0, Lon0/y;->l:Lrn0/u;
...
.method public i(ZLorg/bouncycastle/crypto/k;Lorg/bouncycastle/crypto/k;Lorg/bouncycastle/crypto/k;)V
    ...
    .line 1
    iput-boolean p1, p0, Lon0/y;->g:Z

    iput-object p2, p0, Lon0/y;->h:Lorg/bouncycastle/crypto/k;

    iput-object p3, p0, Lon0/y;->i:Lorg/bouncycastle/crypto/k;

    const/4 p1, 0x0

    new-array p1, p1, [B

    iput-object p1, p0, Lon0/y;->k:[B

    invoke-virtual {p0, p4}, Lon0/y;->c(Lorg/bouncycastle/crypto/k;)V
...
.method public j([BII)[B
    ...
    iget-boolean v1, p0, Lon0/y;->g:Z

    if-eqz v1, :cond_0

    iget-object v0, p0, Lon0/y;->l:Lrn0/u;
    ...
    iput-object v1, p0, Lon0/y;->h:Lorg/bouncycastle/crypto/k;

    invoke-virtual {v0}, Lorg/bouncycastle/crypto/u;->a()[B

    move-result-object v0

    iput-object v0, p0, Lon0/y;->k:[B

    goto :goto_2

    :cond_0
    iget-object v1, p0, Lon0/y;->m:Lorg/bouncycastle/crypto/z;
    ...
    :try_start_0
    iget-object v2, p0, Lon0/y;->m:Lorg/bouncycastle/crypto/z;

    invoke-interface {v2, v1}, Lorg/bouncycastle/crypto/z;->a(Ljava/io/InputStream;)Lzn0/c;

    move-result-object v2

    iput-object v2, p0, Lon0/y;->i:Lorg/bouncycastle/crypto/k;
    :try_end_0
    ...
    :cond_1
    :goto_2
    iget-object v0, p0, Lon0/y;->a:Lorg/bouncycastle/crypto/e;

    iget-object v1, p0, Lon0/y;->h:Lorg/bouncycastle/crypto/k;

    invoke-interface {v0, v1}, Lorg/bouncycastle/crypto/e;->a(Lorg/bouncycastle/crypto/k;)V

    iget-object v0, p0, Lon0/y;->a:Lorg/bouncycastle/crypto/e;

    iget-object v1, p0, Lon0/y;->i:Lorg/bouncycastle/crypto/k;

    invoke-interface {v0, v1}, Lorg/bouncycastle/crypto/e;->b(Lorg/bouncycastle/crypto/k;)Ljava/math/BigInteger;

    move-result-object v0

    iget-object v1, p0, Lon0/y;->a:Lorg/bouncycastle/crypto/e;
    ...
    iget-object v2, p0, Lon0/y;->b:Lorg/bouncycastle/crypto/q;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lon0/y;->b([BII)[B
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Lon0/y;->a([BII)[B
