...
.method public constructor <init>(I)V
    ...
    iput p1, p0, Lon0/v;->d:I

    new-array p1, p1, [J

    iput-object p1, p0, Lon0/v;->a:[J
...
.method private static j(J)J
    ...
    .line 1
    invoke-static {p0, p1}, Lon0/v;->n(J)J

    move-result-wide v0

    const/16 v2, 0x8

    invoke-static {v2, p0, p1}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v4, v2, v3}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v4, p0, p1}, Lon0/v;->p(IJ)J
    ...
    invoke-static {p0, p1}, Lon0/v;->o(J)J

    move-result-wide p0

    const/16 v5, 0x20

    invoke-static {v5, p0, p1}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v2, v0, v1}, Lon0/v;->p(IJ)J

    move-result-wide v2

    xor-long/2addr p0, v2

    invoke-static {v4, v0, v1}, Lon0/v;->p(IJ)J
...
.method public static k(J)J
    ...
    invoke-static {v5, v0, v1}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v5, v6, v7}, Lon0/v;->p(IJ)J

    move-result-wide v14

    invoke-static {v12, v13}, Lon0/v;->n(J)J
    ...
    invoke-static {v4, v12, v13}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v5, v2, v3}, Lon0/v;->p(IJ)J
    ...
    invoke-static {v8, v9}, Lon0/v;->n(J)J
    ...
    invoke-static {v0, v1}, Lon0/v;->n(J)J
...
.method public a(ZLorg/bouncycastle/crypto/k;)V
    ...
    iput v0, p0, Lon0/v;->e:I

    iget v0, p0, Lon0/v;->f:I

    add-int/lit8 v0, v0, 0x1

    new-array v0, v0, [[J

    iput-object v0, p0, Lon0/v;->c:[[J
    ...
    :goto_4
    iget-object v2, p0, Lon0/v;->c:[[J

    array-length v3, v2

    if-ge v1, v3, :cond_7

    iget v3, p0, Lon0/v;->d:I
    ...
    :cond_7
    iget v1, p0, Lon0/v;->e:I

    new-array v1, v1, [J

    iput-object v1, p0, Lon0/v;->b:[J
    ...
    iget p1, p0, Lon0/v;->d:I

    new-array p1, p1, [J

    iget-object p2, p0, Lon0/v;->b:[J

    invoke-virtual {p0, p2, p1}, Lon0/v;->v([J[J)V

    iget-object p2, p0, Lon0/v;->b:[J

    invoke-virtual {p0, p2, p1}, Lon0/v;->u([J[J)V

    invoke-virtual {p0}, Lon0/v;->w()V
...
.method public final d(I)V
    ...
    :goto_0
    iget v1, p0, Lon0/v;->d:I

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Lon0/v;->a:[J
...
.method public e([BI[BI)I
    ...
    .line 1
    iget-object v0, p0, Lon0/v;->b:[J

    if-eqz v0, :cond_7

    invoke-virtual {p0}, Lon0/v;->c()I
    ...
    iget-object v0, p0, Lon0/v;->a:[J

    invoke-static {p1, p2, v0}, Lorg/bouncycastle/util/o;->w([BI[J)V

    invoke-virtual {p0, v2}, Lon0/v;->d(I)V

    :goto_0
    invoke-virtual {p0}, Lon0/v;->s()V

    invoke-virtual {p0}, Lon0/v;->r()V

    invoke-virtual {p0}, Lon0/v;->l()V

    add-int/lit8 v2, v2, 0x1

    iget p1, p0, Lon0/v;->f:I

    if-ne v2, p1, :cond_0

    invoke-virtual {p0, p1}, Lon0/v;->d(I)V

    iget-object p1, p0, Lon0/v;->a:[J

    invoke-static {p1, p3, p4}, Lorg/bouncycastle/util/o;->H([J[BI)V

    goto :goto_2

    :cond_0
    invoke-virtual {p0, v2}, Lon0/v;->x(I)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lon0/v;->g([BI[BI)V
    ...
    invoke-virtual {p0, p1}, Lon0/v;->t(I)V

    iget p1, p0, Lon0/v;->f:I

    :goto_1
    invoke-virtual {p0}, Lon0/v;->m()V

    invoke-virtual {p0}, Lon0/v;->h()V

    invoke-virtual {p0}, Lon0/v;->i()V

    add-int/lit8 p1, p1, -0x1

    if-nez p1, :cond_3

    invoke-virtual {p0, v2}, Lon0/v;->t(I)V
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lon0/v;->x(I)V

    goto :goto_1

    :cond_4
    invoke-virtual {p0, p1, p2, p3, p4}, Lon0/v;->f([BI[BI)V
...
.method public final f([BI[BI)V
    ...
    invoke-static/range {p1 .. p2}, Lorg/bouncycastle/util/o;->v([BI)J
    ...
    invoke-static {v6, v5}, Lorg/bouncycastle/util/o;->v([BI)J

    move-result-wide v5

    iget-object v7, v0, Lon0/v;->c:[[J

    iget v8, v0, Lon0/v;->f:I
    ...
    :goto_0
    invoke-static {v3, v4}, Lon0/v;->k(J)J

    move-result-wide v3

    invoke-static {v5, v6}, Lon0/v;->k(J)J
    ...
    sget-object v6, Lon0/v;->o:[B

    and-int/lit16 v12, v7, 0xff

    aget-byte v12, v6, v12

    sget-object v13, Lon0/v;->p:[B
    ...
    invoke-static {v1, v2, v5, v9}, Lorg/bouncycastle/util/o;->F(J[BI)V

    add-int/lit8 v1, v9, 0x8

    invoke-static {v3, v4, v5, v1}, Lorg/bouncycastle/util/o;->F(J[BI)V
...
.method public final g([BI[BI)V
    ...
    sget-object v6, Lon0/v;->k:[B

    and-int/lit16 v12, v10, 0xff

    aget-byte v12, v6, v12

    sget-object v13, Lon0/v;->l:[B
    ...
    invoke-static {v1, v2}, Lon0/v;->j(J)J

    move-result-wide v1

    invoke-static {v3, v4}, Lon0/v;->j(J)J
    ...
    invoke-static {v1, v2, v6, v9}, Lorg/bouncycastle/util/o;->F(J[BI)V

    add-int/lit8 v1, v9, 0x8

    invoke-static {v3, v4, v6, v1}, Lorg/bouncycastle/util/o;->F(J[BI)V
...
.method public final i()V
    ...
    sget-object v3, Lon0/v;->o:[B

    and-int/lit16 v6, v4, 0xff

    aget-byte v6, v3, v6

    sget-object v7, Lon0/v;->p:[B
...
.method public final l()V
    ...
    invoke-static {v2, v3}, Lon0/v;->j(J)J
...
.method public final m()V
    ...
    invoke-static {v2, v3}, Lon0/v;->k(J)J
...
.method public final s()V
    ...
    sget-object v3, Lon0/v;->k:[B

    and-int/lit16 v6, v4, 0xff

    aget-byte v6, v3, v6

    sget-object v7, Lon0/v;->l:[B
...
.method public final u([J[J)V
    .locals 16

    .line 1
    move-object/from16 v0, p0

    iget v1, v0, Lon0/v;->e:I

    new-array v2, v1, [J

    iget v3, v0, Lon0/v;->d:I
    ...
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lon0/v;->s()V

    invoke-virtual/range {p0 .. p0}, Lon0/v;->r()V

    invoke-virtual/range {p0 .. p0}, Lon0/v;->l()V
    ...
    :cond_4
    iget v8, v0, Lon0/v;->d:I

    iget v9, v0, Lon0/v;->e:I
...
.method public final v([J[J)V
    ...
    iput-object v3, p0, Lon0/v;->a:[J

    const/4 v4, 0x0

    aget-wide v5, v3, v4

    iget v7, p0, Lon0/v;->e:I
...
.method public final w()V
    ...
    :goto_0
    iget v1, p0, Lon0/v;->f:I

    if-ge v0, v1, :cond_0

    iget-object v1, p0, Lon0/v;->c:[[J
    ...
    invoke-virtual {p0, v2, v1}, Lon0/v;->q([J[J)V
