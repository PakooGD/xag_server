...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lon0/k0;->e:Ljava/math/BigInteger;
    ...
    sput-object v0, Lon0/k0;->f:Ljava/math/BigInteger;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lon0/k0;->c:[Ljava/util/Vector;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lon0/k0;->d:Z
...
.method public static f(Ljava/util/Vector;Ljava/util/Vector;)Ljava/math/BigInteger;
    ...
    .line 1
    sget-object v0, Lon0/k0;->e:Ljava/math/BigInteger;

    sget-object v1, Lon0/k0;->f:Ljava/math/BigInteger;
...
.method public a(ZLorg/bouncycastle/crypto/k;)V
    ...
    .line 1
    iput-boolean p1, p0, Lon0/k0;->a:Z
    ...
    :cond_0
    check-cast p2, Lzn0/s1;

    iput-object p2, p0, Lon0/k0;->b:Lzn0/s1;

    iget-boolean p1, p0, Lon0/k0;->a:Z

    if-nez p1, :cond_4

    iget-boolean p1, p0, Lon0/k0;->d:Z
    ...
    :cond_1
    iget-object p1, p0, Lon0/k0;->b:Lzn0/s1;

    check-cast p1, Lzn0/t1;

    invoke-virtual {p1}, Lzn0/t1;->j()Ljava/util/Vector;
    ...
    iget-object v3, p0, Lon0/k0;->c:[Ljava/util/Vector;
    ...
    sget-object v4, Lon0/k0;->f:Ljava/math/BigInteger;

    invoke-virtual {v3, v4}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-boolean v3, p0, Lon0/k0;->d:Z
    ...
    :cond_2
    sget-object v3, Lon0/k0;->e:Ljava/math/BigInteger;
    ...
    invoke-virtual {p1}, Lzn0/t1;->i()Ljava/math/BigInteger;
    ...
    iget-object v6, p0, Lon0/k0;->c:[Ljava/util/Vector;

    aget-object v6, v6, v0

    invoke-virtual {p1}, Lzn0/s1;->f()Ljava/math/BigInteger;

    move-result-object v7

    invoke-virtual {p1}, Lzn0/s1;->h()Ljava/math/BigInteger;
...
.method public b([BII)[B
    ...
    .line 1
    iget-object v0, p0, Lon0/k0;->b:Lzn0/s1;

    if-eqz v0, :cond_c

    invoke-virtual {p0}, Lon0/k0;->d()I
    ...
    iget-boolean v0, p0, Lon0/k0;->a:Z
    ...
    invoke-virtual {p0, p2}, Lon0/k0;->g(Ljava/math/BigInteger;)[B
    ...
    iget-object p3, p0, Lon0/k0;->b:Lzn0/s1;

    check-cast p3, Lzn0/t1;

    invoke-virtual {p3}, Lzn0/t1;->j()Ljava/util/Vector;
    ...
    invoke-virtual {p3}, Lzn0/t1;->i()Ljava/math/BigInteger;
    ...
    invoke-virtual {p3}, Lzn0/s1;->h()Ljava/math/BigInteger;
    ...
    iget-object v4, p0, Lon0/k0;->c:[Ljava/util/Vector;
    ...
    iget-object p3, p0, Lon0/k0;->c:[Ljava/util/Vector;
    ...
    :goto_2
    iget-object p1, p0, Lon0/k0;->c:[Ljava/util/Vector;
    ...
    iget-object p2, p0, Lon0/k0;->c:[Ljava/util/Vector;
    ...
    :cond_a
    invoke-static {p1, v1}, Lon0/k0;->f(Ljava/util/Vector;Ljava/util/Vector;)Ljava/math/BigInteger;
...
.method public c()I
    ...
    invoke-virtual {v0}, Lzn0/s1;->h()Ljava/math/BigInteger;
...
.method public e([B[B)[B
    ...
    iget-object v1, p0, Lon0/k0;->b:Lzn0/s1;

    invoke-virtual {v1}, Lzn0/s1;->h()Ljava/math/BigInteger;
    ...
    iget-boolean v1, p0, Lon0/k0;->d:Z
...
.method public g(Ljava/math/BigInteger;)[B
    ...
    iget-object v2, p0, Lon0/k0;->b:Lzn0/s1;

    invoke-virtual {v2}, Lzn0/s1;->f()Ljava/math/BigInteger;

    move-result-object v2

    iget-object v3, p0, Lon0/k0;->b:Lzn0/s1;

    invoke-virtual {v3}, Lzn0/s1;->h()Ljava/math/BigInteger;
...
.method public h([B)[B
    ...
    .line 1
    iget-boolean v0, p0, Lon0/k0;->d:Z
    ...
    invoke-virtual {p0, p1, v3, v0}, Lon0/k0;->b([BII)[B
    ...
    invoke-virtual {p0, p1, v3, v6}, Lon0/k0;->b([BII)[B
    ...
    :goto_1
    iget-boolean v7, p0, Lon0/k0;->d:Z
    ...
    invoke-virtual {p0, p1, v2, v0}, Lon0/k0;->b([BII)[B
...
.method public i(Z)V
    ...
    .line 1
    iput-boolean p1, p0, Lon0/k0;->d:Z
