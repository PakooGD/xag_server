...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lon0/i1;->a:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lon0/i1;->b:[I
...
.method private g([BI[BI)V
    ...
    invoke-virtual {p0, p1, v0, p2, v1}, Lon0/i1;->d([B[III)V
    ...
    sget-object v2, Lon0/i1;->c:[I

    aget v2, v2, p1

    sub-int/2addr p2, v2

    iget-object v2, p0, Lon0/i1;->b:[I
    ...
    :cond_0
    invoke-virtual {p0, v0, p3, p4}, Lon0/i1;->i([I[BI)V
...
.method private h([BI[BI)V
    ...
    sget-object v7, Lon0/i1;->c:[I

    aget v7, v7, p1

    add-int/2addr v3, v7

    iget-object v7, p0, Lon0/i1;->b:[I
...
.method public a(ZLorg/bouncycastle/crypto/k;)V
    ...
    iput-boolean p1, p0, Lon0/i1;->a:Z

    const/16 p1, 0x40

    new-array p1, p1, [I

    iput-object p1, p0, Lon0/i1;->b:[I
    ...
    invoke-virtual {p0, p1}, Lon0/i1;->j([B)V
...
.method public e([BI[BI)I
    ...
    iget-boolean v0, p0, Lon0/i1;->a:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1, p2, p3, p4}, Lon0/i1;->h([BI[BI)V

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Lon0/i1;->g([BI[BI)V
...
.method public j([B)V
    ...
    invoke-virtual {p0, p1, v0, v3, v3}, Lon0/i1;->f([B[III)V

    :goto_0
    if-ge v2, v1, :cond_0

    iget-object p1, p0, Lon0/i1;->b:[I
