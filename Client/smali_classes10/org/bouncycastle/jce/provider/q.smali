.class public abstract Lorg/bouncycastle/jce/provider/q;
...
.method public static a(Luo0/e;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    :try_start_0
    invoke-static {v0, p0, p3}, Lorg/bouncycastle/jce/provider/q;->b(Ljava/util/HashSet;Luo0/e;Ljava/util/List;)V

    invoke-static {v0, p0, p2}, Lorg/bouncycastle/jce/provider/q;->b(Ljava/util/HashSet;Luo0/e;Ljava/util/List;)V
    :try_end_0
    ...
    :cond_1
    invoke-virtual {p0}, Luo0/e;->c()Ljava/security/cert/X509Certificate;
...
.method public static b(Ljava/util/HashSet;Luo0/e;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/bouncycastle/jce/provider/AnnotatedException;
    ...
    instance-of v3, v2, Lorg/bouncycastle/util/s;
    ...
    :try_start_0
    invoke-interface {v2, p1}, Lorg/bouncycastle/util/s;->a(Lorg/bouncycastle/util/q;)Ljava/util/Collection;
    ...
    :try_start_1
    invoke-static {p1, v2}, Luo0/e;->b(Luo0/e;Ljava/security/cert/CertStore;)Ljava/util/Collection;
