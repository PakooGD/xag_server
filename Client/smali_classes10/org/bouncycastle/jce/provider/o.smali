...
# virtual methods
.method public final a(Lorg/bouncycastle/x509/l;Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 6
    ...
    :cond_0
    invoke-virtual {p3}, Luo0/j;->b()Ljava/util/Set;
    ...
    :try_start_1
    invoke-virtual {p3}, Luo0/j;->a()Luo0/k;
    ...
    invoke-virtual {v3}, Luo0/k;->v()Ljava/lang/String;

    move-result-object v5

    invoke-static {p2, v4, v5}, Lorg/bouncycastle/jce/provider/e;->w(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    invoke-virtual {v3}, Luo0/k;->p()Ljava/util/List;
    ...
    invoke-static {v1, v4}, Lorg/bouncycastle/jce/provider/e;->g([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p2, v3, v0}, Lorg/bouncycastle/jce/provider/e;->c(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-virtual {p0, p1, v1, p3, p4}, Lorg/bouncycastle/jce/provider/o;->a(Lorg/bouncycastle/x509/l;Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iput-object p3, p0, Lorg/bouncycastle/jce/provider/o;->a:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    new-instance v0, Luo0/j$b;

    move-object v2, p1

    check-cast v2, Ljava/security/cert/PKIXBuilderParameters;

    invoke-direct {v0, v2}, Luo0/j$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V
    ...
    invoke-virtual {v0, v1}, Luo0/j$b;->d(Ljava/util/Set;)Luo0/j$b;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/e;->B()I

    move-result v1

    invoke-virtual {v0, v1}, Luo0/j$b;->f(I)Luo0/j$b;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/f;->j()Ljava/util/List;

    move-result-object v1

    :cond_2
    invoke-virtual {v0}, Luo0/j$b;->e()Luo0/j;
    ...
    invoke-virtual {p1}, Luo0/j;->a()Luo0/k;

    move-result-object v2

    invoke-virtual {v2}, Luo0/k;->w()Luo0/i;

    move-result-object v3

    instance-of v4, v3, Lorg/bouncycastle/x509/k;

    if-eqz v4, :cond_e

    :try_start_0
    check-cast v3, Lorg/bouncycastle/x509/k;

    invoke-static {v3, v1}, Lorg/bouncycastle/jce/provider/o;->b(Lorg/bouncycastle/x509/k;Ljava/util/List;)Ljava/util/Collection;
    ...
    check-cast v4, Lorg/bouncycastle/x509/l;

    new-instance v5, Lorg/bouncycastle/x509/o;

    invoke-direct {v5}, Lorg/bouncycastle/x509/o;-><init>()V

    invoke-interface {v4}, Lorg/bouncycastle/x509/l;->d()Lorg/bouncycastle/x509/b;

    move-result-object v6

    invoke-virtual {v6}, Lorg/bouncycastle/x509/b;->b()[Ljava/security/Principal;
    ...
    :cond_5
    :goto_3
    new-instance v9, Luo0/i$b;

    invoke-direct {v9, v5}, Luo0/i$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v9}, Luo0/i$b;->a()Luo0/i;

    move-result-object v9

    invoke-virtual {v2}, Luo0/k;->o()Ljava/util/List;

    move-result-object v10

    invoke-static {v7, v9, v10}, Lorg/bouncycastle/jce/provider/e;->b(Ljava/util/LinkedHashSet;Luo0/i;Ljava/util/List;)V
    ...
    invoke-virtual {p0, v4, v3, p1, v0}, Lorg/bouncycastle/jce/provider/o;->a(Lorg/bouncycastle/x509/l;Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/o;->a:Ljava/lang/Exception;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/o;->a:Ljava/lang/Exception;
