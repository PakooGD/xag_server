...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/jce/provider/h$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/h;->b:Ljava/util/Map;
...
.method public static declared-synchronized a(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Luo0/d;
    .locals 4
    ...
    .line 1
    const-class v0, Lorg/bouncycastle/jce/provider/h;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lorg/bouncycastle/jce/provider/h;->b:Ljava/util/Map;
    ...
    invoke-interface {v1, v2}, Luo0/d;->a(Lorg/bouncycastle/util/q;)Ljava/util/Collection;
    ...
    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/h;->c(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-static {p0, p2}, Lorg/bouncycastle/jce/provider/h;->b(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;

    move-result-object p0

    :goto_2
    new-instance p1, Lorg/bouncycastle/jce/provider/h$a;

    new-instance v1, Lorg/bouncycastle/util/e;

    invoke-direct {v1, p0}, Lorg/bouncycastle/util/e;-><init>(Ljava/util/Collection;)V

    invoke-direct {p1, v1}, Lorg/bouncycastle/jce/provider/h$a;-><init>(Lorg/bouncycastle/util/s;)V

    sget-object p0, Lorg/bouncycastle/jce/provider/h;->b:Ljava/util/Map;
