...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/c0;->a:Ljava/lang/String;

    sget-object v0, Lmm0/y;->G:Luk0/y;

    invoke-virtual {v0}, Luk0/y;->J()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/bouncycastle/jce/provider/c0;->b:Ljava/lang/String;
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/c0;->c:Ljava/lang/String;
    ...
    sput-object v0, Lorg/bouncycastle/jce/provider/c0;->d:Ljava/lang/String;
...
.method public static b(Lmm0/v;Lorg/bouncycastle/x509/l;Luo0/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/f;Lorg/bouncycastle/jce/provider/d0;Ljava/util/List;Lorg/bouncycastle/jcajce/util/d;)V
    .locals 23
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v0, Lmm0/u1;->F:Luk0/y;
    ...
    invoke-direct/range {v2 .. v8}, Luo0/g;-><init>(Luo0/k;Ljava/util/Date;Ljava/security/cert/CertPath;ILjava/security/cert/X509Certificate;Ljava/security/PublicKey;)V

    invoke-static {v0, v1, v9, v10, v11}, Lorg/bouncycastle/jce/provider/e;->l(Luo0/g;Lmm0/v;Ljava/lang/Object;Luo0/k;Ljava/util/Date;)Ljava/util/Set;
    ...
    invoke-virtual/range {p6 .. p6}, Lorg/bouncycastle/jce/provider/f;->a()I
    ...
    invoke-virtual/range {p7 .. p7}, Lorg/bouncycastle/jce/provider/d0;->e()Z
    ...
    invoke-static {v3, v2}, Lorg/bouncycastle/jce/provider/b0;->v(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;
    ...
    :try_start_2
    invoke-static {v6, v3, v4, v5, v7}, Lorg/bouncycastle/jce/provider/e;->m(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;Lorg/bouncycastle/jcajce/util/d;)Ljava/util/Set;

    move-result-object v4

    invoke-static {v4, v2}, Lorg/bouncycastle/jce/provider/b0;->w(Ljava/util/Set;Ljava/security/PublicKey;)Ljava/security/cert/X509CRL;
    ...
    :cond_4
    :goto_2
    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/b0;->q(Lmm0/v;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v1, v9, v3}, Lorg/bouncycastle/jce/provider/b0;->r(Lmm0/v;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    invoke-static {v2, v3, v10}, Lorg/bouncycastle/jce/provider/b0;->s(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Luo0/k;)V

    invoke-static {v11, v2, v9, v12, v10}, Lorg/bouncycastle/jce/provider/b0;->x(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/f;Luo0/k;)V

    invoke-static {v11, v3, v9, v12}, Lorg/bouncycastle/jce/provider/b0;->y(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/bouncycastle/jce/provider/f;)V
    ...
    invoke-virtual {v12, v14}, Lorg/bouncycastle/jce/provider/f;->c(I)V
...
.method public static c(Lorg/bouncycastle/x509/l;Luo0/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Ljava/util/List;Lorg/bouncycastle/jcajce/util/d;)V
    .locals 20
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-virtual/range {p1 .. p1}, Luo0/k;->D()Z

    move-result v0

    if-eqz v0, :cond_a

    sget-object v0, Lorg/bouncycastle/jce/provider/c0;->b:Ljava/lang/String;
    ...
    :try_start_0
    sget-object v0, Lorg/bouncycastle/jce/provider/c0;->c:Ljava/lang/String;

    invoke-static {v11, v0}, Lorg/bouncycastle/jce/provider/e;->n(Ljava/security/cert/X509Extension;Ljava/lang/String;)Luk0/c0;
    ...
    invoke-static {v0, v2, v12, v13}, Lorg/bouncycastle/jce/provider/e;->h(Lmm0/k;Ljava/util/Map;Ljava/util/Date;Lorg/bouncycastle/jcajce/util/d;)Ljava/util/List;
    ...
    invoke-direct {v2, v3}, Luo0/k$b;-><init>(Luo0/k;)V
    ...
    check-cast v4, Luo0/d;

    invoke-virtual {v2, v4}, Luo0/k$b;->m(Luo0/d;)Luo0/k$b;
    ...
    new-instance v15, Lorg/bouncycastle/jce/provider/f;

    invoke-direct {v15}, Lorg/bouncycastle/jce/provider/f;-><init>()V
    ...
    invoke-virtual {v15}, Lorg/bouncycastle/jce/provider/f;->a()I
    ...
    invoke-virtual {v14}, Luo0/k;->clone()Ljava/lang/Object;
    ...
    :try_start_4
    invoke-static/range {v1 .. v10}, Lorg/bouncycastle/jce/provider/c0;->b(Lmm0/v;Lorg/bouncycastle/x509/l;Luo0/k;Ljava/util/Date;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/bouncycastle/jce/provider/f;Lorg/bouncycastle/jce/provider/d0;Ljava/util/List;Lorg/bouncycastle/jcajce/util/d;)V
    :try_end_4
    ...
    :try_start_5
    invoke-static/range {p0 .. p0}, Lorg/bouncycastle/jce/provider/x;->c(Ljava/lang/Object;)Lkm0/d;
    ...
    invoke-virtual {v15, v2}, Lorg/bouncycastle/jce/provider/f;->c(I)V
    ...
    invoke-virtual {v15}, Lorg/bouncycastle/jce/provider/f;->b()Ljava/util/Date;
    ...
    sget-object v0, Lorg/bouncycastle/jce/provider/c0;->d:Ljava/lang/String;
...
.method public static d(Lorg/bouncycastle/x509/l;Luo0/k;)Ljava/security/cert/CertPath;
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/x509/l;->a()Lorg/bouncycastle/x509/a;
    ...
    invoke-virtual {v6}, Lorg/bouncycastle/x509/a;->k()Ljava/math/BigInteger;
    ...
    :cond_0
    :goto_1
    new-instance v8, Luo0/i$b;

    invoke-direct {v8, v2}, Luo0/i$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v8}, Luo0/i$b;->a()Luo0/i;

    move-result-object v8

    invoke-virtual {p1}, Luo0/k;->o()Ljava/util/List;

    move-result-object v9

    invoke-static {v1, v8, v9}, Lorg/bouncycastle/jce/provider/e;->b(Ljava/util/LinkedHashSet;Luo0/i;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-direct {v6, v2}, Luo0/i$b;-><init>(Ljava/security/cert/CertSelector;)V
    ...
    invoke-static {v1, v6, v7}, Lorg/bouncycastle/jce/provider/e;->b(Ljava/util/LinkedHashSet;Luo0/i;Ljava/util/List;)V
    :try_end_1
    ...
    :cond_7
    :goto_9
    new-instance p0, Luo0/k$b;

    invoke-direct {p0, p1}, Luo0/k$b;-><init>(Luo0/k;)V
    ...
    new-instance v4, Luo0/i$b;

    invoke-direct {v4, v3}, Luo0/i$b;-><init>(Ljava/security/cert/CertSelector;)V

    invoke-virtual {v4}, Luo0/i$b;->a()Luo0/i;

    move-result-object v3

    invoke-virtual {p0, v3}, Luo0/k$b;->s(Luo0/i;)Luo0/k$b;
    ...
    invoke-virtual {p0}, Luo0/k$b;->q()Luo0/k;
...
.method public static e(Ljava/security/cert/CertPath;Luo0/k;)Ljava/security/cert/CertPathValidatorResult;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static f(Ljava/security/cert/X509Certificate;Luo0/k;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
...
.method public static i(Lorg/bouncycastle/x509/l;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Luo0/k;Ljava/util/Set;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/cert/CertPathValidatorException;
    ...
    sget-object v1, Lorg/bouncycastle/jce/provider/c0;->a:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0, v1}, Lorg/bouncycastle/jce/provider/e;->n(Ljava/security/cert/X509Extension;Ljava/lang/String;)Luk0/c0;

    move-result-object v2

    invoke-static {v2}, Lmm0/h1;->u(Ljava/lang/Object;)Lmm0/h1;
    :try_end_0
    .catch Lorg/bouncycastle/jce/provider/AnnotatedException; {:try_start_0 .. :try_end_0} :catch_1
