...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/s;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/s;->a:Lorg/bouncycastle/jcajce/util/d;

    iput-boolean p1, p0, Lorg/bouncycastle/jce/provider/s;->b:Z
...
# virtual methods
.method public a(Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    :cond_0
    invoke-virtual {p2}, Luo0/j;->b()Ljava/util/Set;
    ...
    new-instance v2, Lorg/bouncycastle/jce/provider/u;

    iget-boolean v3, p0, Lorg/bouncycastle/jce/provider/s;->b:Z

    invoke-direct {v2, v3}, Lorg/bouncycastle/jce/provider/u;-><init>(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_5

    :try_start_1
    invoke-virtual {p2}, Luo0/j;->a()Luo0/k;

    move-result-object v3

    invoke-virtual {v3}, Luo0/k;->x()Ljava/util/Set;
    ...
    invoke-virtual {v4}, Luo0/k;->v()Ljava/lang/String;

    move-result-object v4

    invoke-static {p1, v3, v4}, Lorg/bouncycastle/jce/provider/e;->w(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Z
    ...
    :try_start_3
    invoke-virtual {v2, v0, p2}, Lorg/bouncycastle/jce/provider/u;->engineValidate(Ljava/security/cert/CertPath;Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathValidatorResult;
    ...
    invoke-virtual {v2}, Luo0/k;->p()Ljava/util/List;
    ...
    :try_start_5
    sget-object v2, Lmm0/y;->i:Luk0/y;
    ...
    invoke-virtual {v3}, Luo0/k;->t()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Lorg/bouncycastle/jce/provider/e;->g([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Luo0/k;->o()Ljava/util/List;

    move-result-object v3

    invoke-static {p1, v3, v0}, Lorg/bouncycastle/jce/provider/e;->c(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p2, p3}, Lorg/bouncycastle/jce/provider/s;->a(Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    :goto_1
    iput-object p2, p0, Lorg/bouncycastle/jce/provider/s;->c:Ljava/lang/Exception;
...
.method public b()Ljava/security/cert/PKIXCertPathChecker;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/s;->a:Lorg/bouncycastle/jcajce/util/d;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-direct {v0, v1}, Luo0/k$b;-><init>(Ljava/security/cert/PKIXParameters;)V
    ...
    check-cast v2, Luo0/h;

    invoke-virtual {v0, v2}, Luo0/k$b;->n(Luo0/h;)Luo0/k$b;

    goto :goto_0

    :cond_0
    new-instance v1, Luo0/j$b;

    invoke-virtual {v0}, Luo0/k$b;->q()Luo0/k;

    move-result-object v0

    invoke-direct {v1, v0}, Luo0/j$b;-><init>(Luo0/k;)V

    invoke-virtual {p1}, Lorg/bouncycastle/x509/e;->A()Ljava/util/Set;

    move-result-object v0

    invoke-virtual {v1, v0}, Luo0/j$b;->d(Ljava/util/Set;)Luo0/j$b;

    invoke-virtual {p1}, Lorg/bouncycastle/x509/e;->B()I

    move-result p1

    invoke-virtual {v1, p1}, Luo0/j$b;->f(I)Luo0/j$b;

    goto :goto_1

    :cond_1
    new-instance p1, Luo0/j$b;

    invoke-direct {p1, v1}, Luo0/j$b;-><init>(Ljava/security/cert/PKIXBuilderParameters;)V

    move-object v1, p1

    :goto_1
    invoke-virtual {v1}, Luo0/j$b;->e()Luo0/j;
    ...
    invoke-static {p1}, Lorg/bouncycastle/jce/provider/e;->d(Luo0/j;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lorg/bouncycastle/jce/provider/s;->a(Ljava/security/cert/X509Certificate;Luo0/j;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/s;->c:Ljava/lang/Exception;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/s;->c:Ljava/lang/Exception;

    invoke-virtual {v0}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/s;->c:Ljava/lang/Exception;
...
.method public bridge synthetic engineGetRevocationChecker()Ljava/security/cert/CertPathChecker;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/s;->b()Ljava/security/cert/PKIXCertPathChecker;
