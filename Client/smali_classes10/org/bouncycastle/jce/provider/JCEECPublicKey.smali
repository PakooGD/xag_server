...
.field private gostParams:Lel0/g;

.field private q:Lmp0/i;
...
.method public constructor <init>(Ljava/lang/String;Ljava/security/spec/ECPublicKeySpec;)V
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/h;->e(Ljava/security/spec/ECParameterSpec;Ljava/security/spec/ECPoint;)Lmp0/i;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;Lkp0/g;)V
    .locals 1
    ...
    :cond_0
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    sget-object p1, Lorg/bouncycastle/jce/provider/BouncyCastleProvider;->CONFIGURATION:Lzo0/c;
    ...
    iget-object p2, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    invoke-virtual {p1, p2, v0}, Lmp0/e;->h(Ljava/math/BigInteger;Ljava/math/BigInteger;)Lmp0/i;
...
.method public constructor <init>(Ljava/lang/String;Lorg/bouncycastle/jce/provider/JCEECPublicKey;)V
    ...
    iget-object p1, p2, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    iget-object p1, p2, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->gostParams:Lel0/g;

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->gostParams:Lel0/g;
...
.method public constructor <init>(Ljava/lang/String;Lzn0/m0;Ljava/security/spec/ECParameterSpec;)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->a(Ljava/security/spec/EllipticCurve;Lzn0/g0;)Ljava/security/spec/ECParameterSpec;
...
.method public constructor <init>(Lmm0/c1;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->c(Lmm0/c1;)V
...
.method private c(Lmm0/c1;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;

    new-instance v0, Lkp0/d;

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->gostParams:Lel0/g;
    ...
    invoke-static {v6, v7}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/h;->a(Lmp0/e;[B)Ljava/security/spec/EllipticCurve;

    move-result-object v10

    new-instance v7, Lkp0/d;
    ...
    invoke-direct/range {v8 .. v13}, Lkp0/d;-><init>(Ljava/lang/String;Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-static {v6, v1}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/h;->a(Lmp0/e;[B)Ljava/security/spec/EllipticCurve;
    ...
    invoke-static {v8}, Lorg/bouncycastle/jcajce/provider/asymmetric/util/h;->d(Lmp0/i;)Ljava/security/spec/ECPoint;
    ...
    :cond_4
    new-instance v1, Lpm0/q;

    invoke-direct {v1}, Lpm0/q;-><init>()V

    invoke-virtual {v1, v6}, Lpm0/q;->a(Lmp0/e;)I
    ...
    invoke-direct {p1, v6, v0}, Lpm0/n;-><init>(Lmp0/e;Luk0/z;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->c(Lmm0/c1;)V
...
# virtual methods
.method public engineGetQ()Lmp0/i;
    .locals 1
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->engineGetQ()Lmp0/i;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->engineGetQ()Lmp0/i;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->engineGetSpec()Lkp0/e;

    move-result-object v0

    invoke-virtual {p1}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->engineGetSpec()Lkp0/e;
...
.method public getEncoded()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->gostParams:Lel0/g;
    ...
    :goto_1
    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->q:Lmp0/i;
    ...
    invoke-direct {p0, v3, v4, v1}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->b([BILjava/math/BigInteger;)V

    const/16 v1, 0x20

    invoke-direct {p0, v3, v1, v2}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->b([BILjava/math/BigInteger;)V
    ...
    :goto_2
    invoke-virtual {p0}, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->getQ()Lmp0/i;

    move-result-object v0

    iget-boolean v2, p0, Lorg/bouncycastle/jce/provider/JCEECPublicKey;->withCompression:Z

    invoke-virtual {v0, v2}, Lmp0/i;->l(Z)[B
    ...
    invoke-direct {v3, v4, v1}, Lmm0/b;-><init>(Luk0/y;Luk0/h;)V

    invoke-direct {v2, v3, v0}, Lmm0/c1;-><init>(Lmm0/b;[B)V
