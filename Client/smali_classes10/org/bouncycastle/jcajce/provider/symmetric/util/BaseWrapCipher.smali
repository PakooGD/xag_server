...
.field public g:Lorg/bouncycastle/crypto/l0;

.field public h:I

.field public i:[B

.field public j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;

.field public k:Z

.field public final l:Lorg/bouncycastle/jcajce/util/d;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->g:Lorg/bouncycastle/crypto/l0;

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;

    new-instance v0, Lorg/bouncycastle/jcajce/util/b;

    invoke-direct {v0}, Lorg/bouncycastle/jcajce/util/b;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->l:Lorg/bouncycastle/jcajce/util/d;

    return-void
.end method

.method public constructor <init>(Lorg/bouncycastle/crypto/l0;)V
    .locals 1

    .line 2
    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;-><init>(Lorg/bouncycastle/crypto/l0;I)V

    return-void
.end method

.method public constructor <init>(Lorg/bouncycastle/crypto/l0;I)V
    .locals 5
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->g:Lorg/bouncycastle/crypto/l0;
...
.method public final a(Ljava/lang/String;)Ljava/security/AlgorithmParameters;
    ...
    .line 1
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->l:Lorg/bouncycastle/jcajce/util/d;
...
.method public engineDoFinal([BII[BI)I
    ...
    .line 1
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;
    ...
    :try_start_0
    iget-boolean p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->k:Z
    :try_end_0
    ...
    :try_start_1
    iget-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->g:Lorg/bouncycastle/crypto/l0;

    iget-object p3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;

    invoke-virtual {p3}, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;->c()[B
    ...
    invoke-interface {p1, p3, p2, v0}, Lorg/bouncycastle/crypto/l0;->c([BII)[B
    ...
    invoke-interface {p1, p3, p2, v0}, Lorg/bouncycastle/crypto/l0;->d([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;
...
.method public engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->g:Lorg/bouncycastle/crypto/l0;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->i:[B
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-direct {v0, p2}, Lzn0/n1;-><init>([B)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->i:[B

    new-instance v1, Lzn0/v1;

    invoke-direct {v1, p2, v0}, Lzn0/v1;-><init>(Lorg/bouncycastle/crypto/k;[B)V

    move-object p2, v1

    :cond_3
    instance-of v0, p3, Lgp0/k;

    if-eqz v0, :cond_5

    check-cast p3, Lgp0/k;

    invoke-virtual {p3}, Lgp0/k;->b()[B
    ...
    invoke-direct {v1, p2, v0}, Lzn0/x1;-><init>(Lorg/bouncycastle/crypto/k;[B)V
    ...
    invoke-virtual {p3}, Lgp0/k;->c()[B

    move-result-object p3

    invoke-direct {v0, p2, p3}, Lzn0/z1;-><init>(Lorg/bouncycastle/crypto/k;[B)V

    move-object p2, v0

    :cond_5
    instance-of p3, p2, Lzn0/n1;
    ...
    invoke-direct {p3, p2, v2}, Lzn0/v1;-><init>(Lorg/bouncycastle/crypto/k;[B)V
    ...
    invoke-interface {p1, p4, p2}, Lorg/bouncycastle/crypto/l0;->a(ZLorg/bouncycastle/crypto/k;)V

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;

    :goto_1
    iput-boolean p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->k:Z
    ...
    invoke-interface {p1, v1, p2}, Lorg/bouncycastle/crypto/l0;->a(ZLorg/bouncycastle/crypto/k;)V

    iput-object p3, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;

    :goto_2
    iput-boolean v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->k:Z
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;
...
.method public engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    ...
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->g:Lorg/bouncycastle/crypto/l0;
    ...
    invoke-interface {v1, p1, v2, v3}, Lorg/bouncycastle/crypto/l0;->d([BII)[B
    ...
    :cond_3
    :try_start_2
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->l:Lorg/bouncycastle/jcajce/util/d;

    invoke-interface {v1, p2}, Lorg/bouncycastle/jcajce/util/d;->b(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method public engineUpdate([BII[BI)I
    ...
    .line 1
    iget-object p4, p0, Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher;->j:Lorg/bouncycastle/jcajce/provider/symmetric/util/BaseWrapCipher$a;
...
.method public engineWrap(Ljava/security/Key;)[B
    ...
    invoke-interface {v0, p1, v1, v2}, Lorg/bouncycastle/crypto/l0;->c([BII)[B
