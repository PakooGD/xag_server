...
.method public constructor <init>(Lcm0/u;)V
    ...
    invoke-direct {p0, v0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Lmm0/b;Lcm0/x;)V
...
.method public constructor <init>(Ljava/security/interfaces/RSAPrivateCrtKey;)V
    ...
    invoke-direct {p0, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lzn0/e2;)V
...
.method public constructor <init>(Lmm0/b;Lcm0/x;)V
    ...
    invoke-virtual {p2}, Lcm0/x;->E()Ljava/math/BigInteger;
    ...
    invoke-virtual {p2}, Lcm0/x;->B()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {p2}, Lcm0/x;->C()Ljava/math/BigInteger;

    move-result-object v5

    invoke-virtual {p2}, Lcm0/x;->v()Ljava/math/BigInteger;

    move-result-object v6

    invoke-virtual {p2}, Lcm0/x;->w()Ljava/math/BigInteger;

    move-result-object v7

    invoke-virtual {p2}, Lcm0/x;->u()Ljava/math/BigInteger;
    ...
    invoke-direct {p0, p1, v9}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lmm0/b;Lzn0/e2;)V
...
.method public constructor <init>(Lmm0/b;Lzn0/f2;)V
    .locals 0

    .line 6
    invoke-direct {p0, p1, p2}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lmm0/b;Lzn0/e2;)V
    ...
    invoke-virtual {p2}, Lzn0/f2;->k()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lzn0/f2;->m()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lzn0/f2;->i()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentP:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lzn0/f2;->j()Ljava/math/BigInteger;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;->primeExponentQ:Ljava/math/BigInteger;

    invoke-virtual {p2}, Lzn0/f2;->n()Ljava/math/BigInteger;
...
.method public constructor <init>(Lzn0/f2;)V
    ...
    .line 7
    invoke-direct {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lzn0/e2;)V
