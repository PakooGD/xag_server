...
# instance fields
.field transient eddsaPublicKey:Lzn0/c;
...
.method public constructor <init>(Lmm0/c1;)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->a(Lmm0/c1;)V
...
.method public constructor <init>(Lzn0/c;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->eddsaPublicKey:Lzn0/c;
...
.method public constructor <init>([B[B)V
    ...
    new-instance p1, Lzn0/s0;

    invoke-direct {p1, p2, v0}, Lzn0/s0;-><init>([BI)V
    ...
    new-instance p1, Lzn0/p0;

    invoke-direct {p1, p2, v0}, Lzn0/p0;-><init>([BI)V
...
.method public final a(Lmm0/c1;)V
    ...
    invoke-direct {p1, v0}, Lzn0/s0;-><init>([B)V
    ...
    invoke-direct {p1, v0}, Lzn0/p0;-><init>([B)V
...
.method public engineGetKeyParameters()Lzn0/c;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->eddsaPublicKey:Lzn0/c;
...
.method public getEncoded()[B
    ...
    sget-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/b;->f:[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/BCEdDSAPublicKey;->eddsaPublicKey:Lzn0/c;

    check-cast v1, Lzn0/s0;

    array-length v0, v0

    invoke-virtual {v1, v2, v0}, Lzn0/s0;->f([BI)V

    return-object v2

    :cond_0
    sget-object v0, Lorg/bouncycastle/jcajce/provider/asymmetric/edec/b;->g:[B
    ...
    check-cast v1, Lzn0/p0;

    array-length v0, v0

    invoke-virtual {v1, v2, v0}, Lzn0/p0;->f([BI)V
...
.method public getPointEncoding()[B
    ...
    instance-of v1, v0, Lzn0/s0;

    if-eqz v1, :cond_0

    check-cast v0, Lzn0/s0;
