...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    new-instance p2, Lwo0/a;

    invoke-direct {p2, v0, p1}, Lwo0/a;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    ...
    invoke-direct {v0, p2, p1}, Lsn0/c;-><init>(Ljava/io/InputStream;Lorg/bouncycastle/crypto/s;)V
    ...
    invoke-interface {p1, v0, v1}, Lorg/bouncycastle/crypto/s;->c([BI)I
    ...
    invoke-static {p2, p1}, Lmr0/c;->g(Ljava/io/InputStream;[B)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    new-instance p2, Lwo0/b;

    invoke-direct {p2, v0, p1}, Lwo0/b;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V

    new-instance p1, Lsn0/d;

    new-instance v0, Lln0/c0;

    invoke-direct {v0}, Lln0/c0;-><init>()V

    invoke-direct {p1, v0}, Lsn0/d;-><init>(Lorg/bouncycastle/crypto/s;)V

    new-instance v0, Lmr0/e;

    invoke-direct {v0, p2, p1}, Lmr0/e;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V

    invoke-virtual {p0, v0}, Lorg/bouncycastle/jcajce/provider/keystore/bc/BcKeyStoreSpi;->j(Ljava/io/OutputStream;)V

    invoke-virtual {p1}, Lsn0/d;->a()[B

    move-result-object p1

    invoke-virtual {p2, p1}, Ljava/io/OutputStream;->write([B)V

    invoke-virtual {p2}, Lwo0/b;->close()V
