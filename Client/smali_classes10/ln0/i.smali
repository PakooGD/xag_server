...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lln0/i;->j:[[B

    new-array v0, v0, [B

    fill-array-data v0, :array_c

    sput-object v0, Lln0/i;->k:[B
...
.method public constructor <init>([B)V
    ...
    iput-object v1, p0, Lln0/i;->a:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lln0/i;->b:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lln0/i;->c:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lln0/i;->d:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lln0/i;->e:[B

    new-array v2, v0, [B

    iput-object v2, p0, Lln0/i;->f:[B

    new-array v3, v0, [B

    iput-object v3, p0, Lln0/i;->g:[B

    new-array v3, v0, [B

    iput-object v3, p0, Lln0/i;->h:[B

    iput v0, p0, Lln0/i;->i:I
...
.method public final a([B[B)V
    ...
    invoke-virtual {p0, p1, p2}, Lln0/i;->o([B[B)V

    invoke-virtual {p0, p1}, Lln0/i;->d([B)V
    ...
    iget-object p2, p0, Lln0/i;->d:[B

    sget-object v0, Lln0/i;->j:[[B

    aget-object v0, v0, v2

    invoke-virtual {p0, p2, v0}, Lln0/i;->o([B[B)V

    iget-object p2, p0, Lln0/i;->d:[B

    invoke-virtual {p0, p2}, Lln0/i;->d([B)V
    ...
    sget-object v1, Lln0/i;->j:[[B

    aget-object p2, v1, p2

    invoke-virtual {p0, v0, p2}, Lln0/i;->o([B[B)V
...
.method public c([BI)I
    ...
    iget v5, p0, Lln0/i;->i:I

    if-eq v5, v1, :cond_1

    iget-object v6, p0, Lln0/i;->h:[B

    invoke-static {v6, v5, v3, v4, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    :cond_1
    iget-object v3, p0, Lln0/i;->f:[B

    iget-object v4, p0, Lln0/i;->b:[B

    iget-object v5, p0, Lln0/i;->e:[B

    invoke-virtual {p0, v3, v4, v5}, Lln0/i;->m([B[B[B)V

    iget-object v3, p0, Lln0/i;->b:[B

    mul-int/lit8 v0, v0, 0x8

    invoke-virtual {p0, v3, v0}, Lln0/i;->k([BI)V

    iget-object v0, p0, Lln0/i;->c:[B

    iget-object v3, p0, Lln0/i;->e:[B

    invoke-virtual {p0, v0, v3}, Lln0/i;->l([B[B)V

    iget-object v0, p0, Lln0/i;->f:[B

    sget-object v3, Lln0/i;->k:[B

    iget-object v4, p0, Lln0/i;->b:[B

    invoke-virtual {p0, v0, v3, v4}, Lln0/i;->m([B[B[B)V

    iget-object v0, p0, Lln0/i;->f:[B

    iget-object v4, p0, Lln0/i;->c:[B

    invoke-virtual {p0, v0, v3, v4}, Lln0/i;->m([B[B[B)V

    iget-object v0, p0, Lln0/i;->f:[B

    iget-object v3, p0, Lln0/i;->g:[B

    invoke-virtual {p0, v0, v3}, Lln0/i;->n([B[B)V

    iget-object v0, p0, Lln0/i;->g:[B

    invoke-static {v0, v2, p1, p2, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-virtual {p0}, Lln0/i;->reset()V

    return v1
.end method

.method public abstract copy()Lorg/bouncycastle/util/m;
.end method
...
.method public j(Lorg/bouncycastle/util/m;)V
    ...
    iget-object v0, p1, Lln0/i;->a:[B

    iget-object v1, p0, Lln0/i;->a:[B
    ...
    iget-object v0, p1, Lln0/i;->b:[B

    iget-object v1, p0, Lln0/i;->b:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p1, Lln0/i;->c:[B

    iget-object v1, p0, Lln0/i;->c:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p1, Lln0/i;->d:[B

    iget-object v1, p0, Lln0/i;->d:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p1, Lln0/i;->e:[B

    iget-object v1, p0, Lln0/i;->e:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p1, Lln0/i;->f:[B

    iget-object v1, p0, Lln0/i;->f:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v0, p1, Lln0/i;->h:[B

    iget-object v1, p0, Lln0/i;->h:[B

    invoke-static {v0, v2, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p1, p1, Lln0/i;->i:I

    iput p1, p0, Lln0/i;->i:I
...
.method public final m([B[B[B)V
    ...
    invoke-virtual {p0, p1, p3}, Lln0/i;->a([B[B)V

    iget-object p2, p0, Lln0/i;->g:[B

    invoke-virtual {p0, p1, p2}, Lln0/i;->o([B[B)V

    invoke-virtual {p0, p1, p3}, Lln0/i;->o([B[B)V
...
.method public update(B)V
    ...
    iget v1, p0, Lln0/i;->i:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p0, Lln0/i;->i:I

    aput-byte p1, v0, v1

    if-nez v1, :cond_0

    iget-object p1, p0, Lln0/i;->f:[B

    iget-object v1, p0, Lln0/i;->b:[B

    invoke-virtual {p0, p1, v1, v0}, Lln0/i;->m([B[B[B)V

    iget-object p1, p0, Lln0/i;->b:[B

    const/16 v0, 0x200

    invoke-virtual {p0, p1, v0}, Lln0/i;->k([BI)V

    iget-object p1, p0, Lln0/i;->c:[B

    iget-object v0, p0, Lln0/i;->h:[B

    invoke-virtual {p0, p1, v0}, Lln0/i;->l([B[B)V
...
.method public update([BII)V
    ...
    invoke-virtual {p0, p2}, Lln0/i;->update(B)V
    ...
    iget-object v2, p0, Lln0/i;->h:[B

    invoke-virtual {p0, v0, v2}, Lln0/i;->n([B[B)V

    iget-object v0, p0, Lln0/i;->f:[B

    iget-object v2, p0, Lln0/i;->b:[B

    iget-object v3, p0, Lln0/i;->h:[B

    invoke-virtual {p0, v0, v2, v3}, Lln0/i;->m([B[B[B)V

    iget-object v0, p0, Lln0/i;->b:[B

    const/16 v2, 0x200

    invoke-virtual {p0, v0, v2}, Lln0/i;->k([BI)V

    iget-object v0, p0, Lln0/i;->c:[B

    iget-object v2, p0, Lln0/i;->h:[B

    invoke-virtual {p0, v0, v2}, Lln0/i;->l([B[B)V
