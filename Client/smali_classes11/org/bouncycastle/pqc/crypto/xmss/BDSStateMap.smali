...
.method public constructor <init>(Lorg/bouncycastle/pqc/crypto/xmss/w;J[B[B)V
    .locals 11
    ...
    invoke-virtual {p1}, Lorg/bouncycastle/pqc/crypto/xmss/w;->a()I
    ...
    invoke-virtual/range {v0 .. v5}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->updateState(Lorg/bouncycastle/pqc/crypto/xmss/w;J[B[B)V
...
.method public update(I[B[BLorg/bouncycastle/pqc/crypto/xmss/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
    .locals 3
    ...
    invoke-virtual {p1, p2, p3, p4}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->getNextState([B[BLorg/bouncycastle/pqc/crypto/xmss/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
...
.method public updateState(Lorg/bouncycastle/pqc/crypto/xmss/w;J[B[B)V
    .locals 16
    ...
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/pqc/crypto/xmss/w;->j()Lorg/bouncycastle/pqc/crypto/xmss/d0;
    ...
    invoke-static {v1, v2, v6}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->l(JI)J

    move-result-wide v7

    invoke-static {v1, v2, v6}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->k(JI)I
    ...
    invoke-virtual {v10, v7, v8}, Lorg/bouncycastle/pqc/crypto/xmss/o$a;->i(J)Lorg/bouncycastle/pqc/crypto/xmss/o$a;

    move-result-object v10

    check-cast v10, Lorg/bouncycastle/pqc/crypto/xmss/g$b;

    invoke-virtual {v10, v9}, Lorg/bouncycastle/pqc/crypto/xmss/g$b;->p(I)Lorg/bouncycastle/pqc/crypto/xmss/g$b;

    move-result-object v10

    invoke-virtual {v10}, Lorg/bouncycastle/pqc/crypto/xmss/g$b;->e()Lorg/bouncycastle/pqc/crypto/xmss/o;

    move-result-object v10

    check-cast v10, Lorg/bouncycastle/pqc/crypto/xmss/g;
    ...
    invoke-direct {v9, v5, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lorg/bouncycastle/pqc/crypto/xmss/d0;[B[BLorg/bouncycastle/pqc/crypto/xmss/g;)V

    invoke-virtual {v0, v13, v9}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->put(ILorg/bouncycastle/pqc/crypto/xmss/BDS;)V

    :cond_1
    invoke-virtual {v0, v13, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->update(I[B[BLorg/bouncycastle/pqc/crypto/xmss/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;

    :cond_2
    :goto_0
    invoke-virtual/range {p1 .. p1}, Lorg/bouncycastle/pqc/crypto/xmss/w;->b()I

    move-result v9

    if-ge v11, v9, :cond_6

    invoke-static {v7, v8, v6}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->k(JI)I

    move-result v9

    invoke-static {v7, v8, v6}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->l(JI)J
    ...
    invoke-virtual {v10, v11}, Lorg/bouncycastle/pqc/crypto/xmss/o$a;->h(I)Lorg/bouncycastle/pqc/crypto/xmss/o$a;
    ...
    invoke-static {v1, v2, v6, v11}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->p(JII)Z
    ...
    invoke-direct {v15, v5, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;-><init>(Lorg/bouncycastle/pqc/crypto/xmss/d0;[B[BLorg/bouncycastle/pqc/crypto/xmss/g;)V
    ...
    invoke-static {v1, v2, v6, v11}, Lorg/bouncycastle/pqc/crypto/xmss/k0;->o(JII)Z

    move-result v9

    if-eqz v9, :cond_5

    invoke-virtual {v0, v11, v3, v4, v10}, Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;->update(I[B[BLorg/bouncycastle/pqc/crypto/xmss/g;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
...
.method public withWOTSDigest(Luk0/y;)Lorg/bouncycastle/pqc/crypto/xmss/BDSStateMap;
    .locals 5
    ...
    invoke-virtual {v4, p1}, Lorg/bouncycastle/pqc/crypto/xmss/BDS;->withWOTSDigest(Luk0/y;)Lorg/bouncycastle/pqc/crypto/xmss/BDS;
