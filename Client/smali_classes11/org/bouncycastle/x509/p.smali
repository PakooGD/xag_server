...
.method public constructor <init>(Ljava/security/cert/X509Certificate;Ljava/security/cert/X509Certificate;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/x509/p;->a:Lorg/bouncycastle/jcajce/util/d;
...
.method public constructor <init>(Lmm0/q;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lmm0/q;->u()Lmm0/o;
    ...
    invoke-direct {v0, v1}, Lorg/bouncycastle/jce/provider/X509CertificateObject;-><init>(Lmm0/o;)V

    iput-object v0, p0, Lorg/bouncycastle/x509/p;->b:Ljava/security/cert/X509Certificate;

    :cond_0
    invoke-virtual {p1}, Lmm0/q;->w()Lmm0/o;
...
.method public a()[B
    ...
    invoke-direct {v0, v2}, Luk0/s;-><init>([B)V
    ...
    invoke-direct {v1, v2}, Luk0/s;-><init>([B)V

    invoke-virtual {v1}, Luk0/s;->t()Luk0/c0;

    move-result-object v1

    invoke-static {v1}, Lmm0/o;->v(Ljava/lang/Object;)Lmm0/o;
    ...
    :cond_3
    :goto_1
    new-instance v2, Lmm0/q;

    invoke-direct {v2, v0, v1}, Lmm0/q;-><init>(Lmm0/o;Lmm0/o;)V
