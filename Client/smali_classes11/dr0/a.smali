...
.method public a(Lmm0/c1;)Ljava/security/PublicKey;
    ...
    invoke-static {p1}, Llq0/j;->z(Ljava/lang/Object;)Llq0/j;

    move-result-object p1

    new-instance v0, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPublicKey;

    invoke-virtual {p1}, Llq0/j;->y()I

    move-result v1

    invoke-virtual {p1}, Llq0/j;->u()[[S

    move-result-object v2

    invoke-virtual {p1}, Llq0/j;->w()[[S

    move-result-object v3

    invoke-virtual {p1}, Llq0/j;->v()[S
...
.method public b(Lcm0/u;)Ljava/security/PrivateKey;
    ...
    invoke-static {p1}, Llq0/i;->w(Ljava/lang/Object;)Llq0/i;

    move-result-object p1

    new-instance v7, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPrivateKey;

    invoke-virtual {p1}, Llq0/i;->y()[[S

    move-result-object v1

    invoke-virtual {p1}, Llq0/i;->u()[S

    move-result-object v2

    invoke-virtual {p1}, Llq0/i;->z()[[S

    move-result-object v3

    invoke-virtual {p1}, Llq0/i;->v()[S

    move-result-object v4

    invoke-virtual {p1}, Llq0/i;->C()[I

    move-result-object v5

    invoke-virtual {p1}, Llq0/i;->A()[Lsq0/a;
...
.method public engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    instance-of v0, p1, Lhr0/i;

    if-eqz v0, :cond_0

    new-instance v0, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPrivateKey;

    check-cast p1, Lhr0/i;

    invoke-direct {v0, p1}, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPrivateKey;-><init>(Lhr0/i;)V
    ...
    invoke-virtual {p0, p1}, Ldr0/a;->b(Lcm0/u;)Ljava/security/PrivateKey;
...
.method public engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    instance-of v0, p1, Lhr0/j;

    if-eqz v0, :cond_0

    new-instance v0, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPublicKey;

    check-cast p1, Lhr0/j;

    invoke-direct {v0, p1}, Lorg/bouncycastle/pqc/jcajce/provider/rainbow/BCRainbowPublicKey;-><init>(Lhr0/j;)V
    ...
    invoke-virtual {p0, p1}, Ldr0/a;->a(Lmm0/c1;)Ljava/security/PublicKey;
...
.method public final engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    invoke-direct/range {v0 .. v6}, Lhr0/i;-><init>([[S[S[[S[S[I[Lsq0/a;)V
    ...
    invoke-direct {p2, v0, v1, v2, p1}, Lhr0/j;-><init>(I[[S[[S[S)V
