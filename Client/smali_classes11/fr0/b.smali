...
.method public final a([BII[BI)I
    ...
    invoke-virtual {p0, p3}, Lfr0/b;->i(I)I

    move-result v1

    if-lt v0, v1, :cond_0

    invoke-virtual {p0, p1, p2, p3}, Lfr0/b;->d([BII)[B
...
.method public final i(I)I
    ...
    invoke-virtual {p0, p1}, Lfr0/b;->s(I)I
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lfr0/b;->r(I)I
...
.method public final j()Ljava/security/spec/AlgorithmParameterSpec;
    ...
    .line 1
    iget-object v0, p0, Lfr0/b;->d:Ljava/security/spec/AlgorithmParameterSpec;
...
.method public final k(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    invoke-virtual {p0, p1, p2}, Lfr0/b;->t(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
...
.method public final l(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lfr0/b;->u(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
...
.method public final o([BII[BI)I
    ...
    invoke-virtual {p0, p1, p2, p3}, Lfr0/b;->q([BII)[B
...
.method public final v(Ljava/security/Key;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, v0}, Lfr0/b;->k(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    :try_end_0
...
.method public final w(Ljava/security/Key;)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Lfr0/b;->l(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final x(Ljava/security/Key;Ljava/security/SecureRandom;)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, v0, p2}, Lfr0/b;->l(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    :try_end_0
    .catch Ljava/security/InvalidAlgorithmParameterException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final y(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lfr0/b;->l(Ljava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
