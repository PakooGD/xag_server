...
.field private final loadStateListener:Lkotlin/reflect/i;
    .annotation build Las0/k;
    .end annotation
...
.method public constructor <init>(Landroidx/recyclerview/widget/ListUpdateCallback;Landroidx/recyclerview/widget/AsyncDifferConfig;)V
    ...
    iput-object v1, p0, Landroidx/paging/AsyncPagedListDiffer;->loadStateListener:Lkotlin/reflect/i;
...
.method public addLoadStateListener(Lvf0/p;)V
    ...
    .line 9
    .line 10
    invoke-virtual {v0, p1}, Landroidx/paging/PagedList;->addWeakLoadStateListener(Lvf0/p;)V
...
.method public final addPagedListListener(Lvf0/p;)V
    .locals 2
    .param p1    # Lvf0/p;
        .annotation build Las0/k;
        .end annotation
    ...
    invoke-direct {v1, p1}, Landroidx/paging/AsyncPagedListDiffer$OnCurrentListChangedWrapper;-><init>(Lvf0/p;)V
...
.method public final latchPagedList$paging_runtime_release(Landroidx/paging/PagedList;Landroidx/paging/PagedList;Landroidx/paging/PlaceholderPaddedDiffResult;Landroidx/paging/RecordingCallback;ILjava/lang/Runnable;)V
    ...
    .line 32
    .line 33
    iget-object v1, p0, Landroidx/paging/AsyncPagedListDiffer;->loadStateListener:Lkotlin/reflect/i;
    ...
    .line 36
    .line 37
    invoke-virtual {p1, v1}, Landroidx/paging/PagedList;->addWeakLoadStateListener(Lvf0/p;)V
    ...
    .line 93
    invoke-static {p2, p4, p3}, Ldg0/s;->I(III)I
    ...
    .line 107
    .line 108
    const-string/jumbo p2, "must be in snapshot state to apply diff"
...
.method public removeLoadStateListener(Lvf0/p;)V
    ...
    .line 14
    .line 15
    invoke-virtual {v0, p1}, Landroidx/paging/PagedList;->removeWeakLoadStateListener(Lvf0/p;)V
...
.method public final removePagedListListener(Lvf0/p;)V
    .locals 2
    .param p1    # Lvf0/p;
        .annotation build Las0/k;
        .end annotation
    ...
    invoke-direct {v1, p1}, Landroidx/paging/AsyncPagedListDiffer$removePagedListListener$1;-><init>(Lvf0/p;)V
...
.method public submitList(Landroidx/paging/PagedList;Ljava/lang/Runnable;)V
    ...
    .line 7
    iget-object p1, p0, Landroidx/paging/AsyncPagedListDiffer;->loadStateListener:Lkotlin/reflect/i;
    ...
    .line 15
    iget-object v4, p0, Landroidx/paging/AsyncPagedListDiffer;->loadStateListener:Lkotlin/reflect/i;

    check-cast v4, Lvf0/p;

    invoke-virtual {v0, v4}, Landroidx/paging/PagedList;->removeWeakLoadStateListener(Lvf0/p;)V
    ...
    .line 23
    iget-object v0, p0, Landroidx/paging/AsyncPagedListDiffer;->loadStateListener:Lkotlin/reflect/i;

    check-cast v0, Lvf0/p;

    invoke-virtual {p1, v0}, Landroidx/paging/PagedList;->addWeakLoadStateListener(Lvf0/p;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/paging/PagedList;->removeWeakLoadStateListener(Lvf0/p;)V
    ...
    const-string/jumbo v1, "null cannot be cast to non-null type androidx.paging.PagedList<T of androidx.paging.AsyncPagedListDiffer.submitList$lambda$0>"
    ...
    const-string/jumbo v1, "null cannot be cast to non-null type androidx.paging.PagedList<T of androidx.paging.AsyncPagedListDiffer>"
    ...
    const-string/jumbo p2, "must be in snapshot state to diff"
