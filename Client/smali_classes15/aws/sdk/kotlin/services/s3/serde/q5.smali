.class public final Laws/sdk/kotlin/services/s3/serde/q5;
...
.annotation system Ldalvik/annotation/SourceDebugExtension;
    value = "SMAP\nGetBucketNotificationConfigurationOperationDeserializer.kt\nKotlin\n*S Kotlin\n*F\n+ 1 GetBucketNotificationConfigurationOperationDeserializer.kt\naws/sdk/kotlin/services/s3/serde/GetBucketNotificationConfigurationOperationDeserializerKt\n+ 2 fake.kt\nkotlin/jvm/internal/FakeKt\n*L\n1#1,96:1\n1#2:97\n*E\n"
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lkotlin/z1;",
        "c",
        "(Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;[B)V",
        "s3"
    }
    k = 0x2
    mv = {
...
# direct methods
.method public static final synthetic a(Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;[B)V
    .locals 0

    .line 1
    invoke-static {p0, p1}, Laws/sdk/kotlin/services/s3/serde/q5;->c(Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;[B)V
...
.method public static final synthetic b(Ld1/a;Laws/smithy/kotlin/runtime/http/n;[B)Ljava/lang/Void;
    ...
    .line 1
    invoke-static {p0, p1, p2}, Laws/sdk/kotlin/services/s3/serde/q5;->d(Ld1/a;Laws/smithy/kotlin/runtime/http/n;[B)Ljava/lang/Void;
...
.method public static final c(Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;[B)V
    .locals 3
    ...
    .line 24
    :sswitch_0
    const-string v2, "CloudFunctionConfiguration"
    ...
    .line 33
    :cond_1
    invoke-static {v0}, Laws/sdk/kotlin/services/s3/serde/l9;->a(Laws/smithy/kotlin/runtime/serde/xml/o1;)Laws/sdk/kotlin/services/s3/model/LambdaFunctionConfiguration;
    ...
    .line 37
    invoke-virtual {p0}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->getLambdaFunctionConfigurations()Ljava/util/List;
    ...
    .line 45
    invoke-virtual {p0, v1}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->setLambdaFunctionConfigurations(Ljava/util/List;)V
    ...
    .line 56
    .line 57
    invoke-static {v0}, Laws/sdk/kotlin/services/s3/serde/y3;->a(Laws/smithy/kotlin/runtime/serde/xml/o1;)Laws/sdk/kotlin/services/s3/model/EventBridgeConfiguration;
    ...
    .line 61
    invoke-virtual {p0, v1}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->setEventBridgeConfiguration(Laws/sdk/kotlin/services/s3/model/EventBridgeConfiguration;)V
    ...
    .line 65
    :sswitch_2
    const-string v2, "TopicConfiguration"
    ...
    .line 74
    :cond_2
    invoke-static {v0}, Laws/sdk/kotlin/services/s3/serde/ti;->a(Laws/smithy/kotlin/runtime/serde/xml/o1;)Laws/sdk/kotlin/services/s3/model/TopicConfiguration;
    ...
    .line 78
    invoke-virtual {p0}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->getTopicConfigurations()Ljava/util/List;
    ...
    .line 86
    invoke-virtual {p0, v1}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->setTopicConfigurations(Ljava/util/List;)V
    ...
    .line 90
    :sswitch_3
    const-string v2, "QueueConfiguration"
    ...
    .line 99
    :cond_3
    invoke-static {v0}, Laws/sdk/kotlin/services/s3/serde/pg;->a(Laws/smithy/kotlin/runtime/serde/xml/o1;)Laws/sdk/kotlin/services/s3/model/QueueConfiguration;
    ...
    .line 103
    invoke-virtual {p0}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->getQueueConfigurations()Ljava/util/List;
    ...
    .line 111
    invoke-virtual {p0, v1}, Laws/sdk/kotlin/services/s3/model/GetBucketNotificationConfigurationResponse$Builder;->setQueueConfigurations(Ljava/util/List;)V
    ...
    :sswitch_data_0
    .sparse-switch
        -0x210db47b -> :sswitch_3
        -0x1347d9 -> :sswitch_2
        0x393ef713 -> :sswitch_1
        0x644fa0e9 -> :sswitch_0
    .end sparse-switch
.end method
