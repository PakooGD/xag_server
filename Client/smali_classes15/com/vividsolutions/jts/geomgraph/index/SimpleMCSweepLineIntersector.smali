...
.method private add(Lcom/vividsolutions/jts/geomgraph/Edge;Ljava/lang/Object;)V
    ...
    .line 7
    invoke-virtual {p1}, Lcom/vividsolutions/jts/geomgraph/Edge;->getMonotoneChainEdge()Lcom/vividsolutions/jts/geomgraph/index/MonotoneChainEdge;

    move-result-object p1

    .line 8
    invoke-virtual {p1}, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChainEdge;->getStartIndexes()[I
    ...
    .line 10
    new-instance v2, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChain;

    invoke-direct {v2, p1, v1}, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChain;-><init>(Lcom/vividsolutions/jts/geomgraph/index/MonotoneChainEdge;I)V

    .line 11
    new-instance v3, Lcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;

    invoke-virtual {p1, v1}, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChainEdge;->getMinX(I)D

    move-result-wide v4

    invoke-direct {v3, p2, v4, v5, v2}, Lcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;-><init>(Ljava/lang/Object;DLjava/lang/Object;)V
    ...
    new-instance v4, Lcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;

    invoke-virtual {p1, v1}, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChainEdge;->getMaxX(I)D

    move-result-wide v5

    invoke-direct {v4, v5, v6, v3}, Lcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;-><init>(DLcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;)V
...
.method private computeIntersections(Lcom/vividsolutions/jts/geomgraph/index/SegmentIntersector;)V
    ...
    .line 7
    iput v0, p0, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->nOverlaps:I
    ...
    invoke-direct {p0, v0, v2, v1, p1}, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->processOverlaps(IILcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;Lcom/vividsolutions/jts/geomgraph/index/SegmentIntersector;)V
...
.method private prepareEvents()V
    ...
    .line 1
    iget-object v0, p0, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->events:Ljava/util/List;
...
.method private processOverlaps(IILcom/vividsolutions/jts/geomgraph/index/SweepLineEvent;Lcom/vividsolutions/jts/geomgraph/index/SegmentIntersector;)V
    ...
    .line 5
    check-cast v0, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChain;
    ...
    .line 34
    .line 35
    invoke-virtual {v0, v2, p4}, Lcom/vividsolutions/jts/geomgraph/index/MonotoneChain;->computeIntersections(Lcom/vividsolutions/jts/geomgraph/index/MonotoneChain;Lcom/vividsolutions/jts/geomgraph/index/SegmentIntersector;)V

    .line 36
    .line 37
    .line 38
    iget v1, p0, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->nOverlaps:I
    ...
    .line 41
    .line 42
    iput v1, p0, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->nOverlaps:I
...
.method public computeIntersections(Ljava/util/List;Lcom/vividsolutions/jts/geomgraph/index/SegmentIntersector;Z)V
    ...
    .line 1
    invoke-direct {p0, p1, p3}, Lcom/vividsolutions/jts/geomgraph/index/SimpleMCSweepLineIntersector;->add(Ljava/util/List;Ljava/lang/Object;)V
