...
.method public static a(Landroid/content/Context;Lcn/jpush/android/api/NotificationMessage;Ljava/lang/String;)V
    ...
    invoke-static {p0, v2}, Lcn/jpush/android/ac/c;->c(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcn/jpush/android/ac/c;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v4, p1}, Lcn/jpush/android/ac/a;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
...
.method public static a(Lcn/jpush/android/service/JPushMessageReceiver;Landroid/content/Context;Landroid/content/Intent;)V
    ...
    sget-boolean v1, Lcn/jpush/android/helper/a;->a:Z

    if-nez v1, :cond_5

    sput-boolean v4, Lcn/jpush/android/helper/a;->a:Z

    new-instance v1, Lcn/jpush/android/api/CmdMessage;

    const/16 v4, 0x7d8

    invoke-direct {v1, v2, v4, v3, p2}, Lcn/jpush/android/api/CmdMessage;-><init>(IILjava/lang/String;Landroid/os/Bundle;)V

    invoke-virtual {p0, p1, v1}, Lcn/jpush/android/service/JPushMessageReceiver;->onCommandResult(Landroid/content/Context;Lcn/jpush/android/api/CmdMessage;)V
