...
.method public static addLocalNotification(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
    ...
    invoke-static {p0, p1}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;Lcn/jpush/android/data/JPushLocalNotification;)V
...
.method public static clearAllNotifications(Landroid/content/Context;)V
    ...
    const-string v1, "third_all_notify"
...
.method public static clearLocalNotifications(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;)V
...
.method public static filterValidTags(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lcn/jpush/android/aa/a;->a(Ljava/util/Set;)Ljava/util/Set;
...
.method public static getStringTags(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcn/jpush/android/aa/a;->b(Ljava/util/Set;)Ljava/lang/String;
...
.method public static goToAppNotificationSettings(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/q/b;->e(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcn/jpush/android/q/b;->f(Landroid/content/Context;)Z
...
.method public static init(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcn/jpush/android/ac/a;->g(Landroid/content/Context;)Z
...
.method public static removeLocalNotification(Landroid/content/Context;J)V
    ...
    invoke-static {p0, p1, p2}, Lcn/jpush/android/o/d;->a(Landroid/content/Context;J)V
...
.method public static setPushTime(Landroid/content/Context;Ljava/util/Set;II)V
    ...
    invoke-static {p0}, Lcn/jpush/android/ac/a;->a(Landroid/content/Context;)Z
