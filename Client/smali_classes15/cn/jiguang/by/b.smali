...
# static fields
.field private static volatile a:Lcn/jiguang/by/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jiguang/by/b;->b:Ljava/lang/Object;
...
.method private constructor <init>()V
    ...
    iput-wide v0, p0, Lcn/jiguang/by/b;->c:J

    const-wide/32 v0, 0xdbba0

    iput-wide v0, p0, Lcn/jiguang/by/b;->d:J

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcn/jiguang/by/b;->e:Ljava/util/Map;
...
.method private a(Landroid/content/Context;Ljava/lang/String;JJ)Landroid/util/Pair;
    ...
    .line 1
    iget-object v0, p0, Lcn/jiguang/by/b;->e:Ljava/util/Map;
    ...
    invoke-direct {p0, p1, p2}, Lcn/jiguang/by/b;->a(Landroid/content/Context;Ljava/lang/String;)[Ljava/net/InetAddress;
...
.method public static a()Lcn/jiguang/by/b;
    .locals 2

    .line 2
    sget-object v0, Lcn/jiguang/by/b;->a:Lcn/jiguang/by/b;

    if-nez v0, :cond_1

    sget-object v0, Lcn/jiguang/by/b;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jiguang/by/b;->a:Lcn/jiguang/by/b;

    if-nez v1, :cond_0

    new-instance v1, Lcn/jiguang/by/b;

    invoke-direct {v1}, Lcn/jiguang/by/b;-><init>()V

    sput-object v1, Lcn/jiguang/by/b;->a:Lcn/jiguang/by/b;
...
.method public static synthetic a(Lcn/jiguang/by/b;)Ljava/util/Map;
    .locals 0

    .line 5
    iget-object p0, p0, Lcn/jiguang/by/b;->e:Ljava/util/Map;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    invoke-direct {p0, v4}, Lcn/jiguang/by/b;->a(Ljava/lang/String;)Ljava/net/InetAddress;
...
.method public a(Landroid/content/Context;Ljava/lang/String;JZ)Ljava/net/InetAddress;
    ...
    .line 3
    invoke-virtual/range {p0 .. p5}, Lcn/jiguang/by/b;->b(Landroid/content/Context;Ljava/lang/String;JZ)[Ljava/net/InetAddress;
...
.method public b(Landroid/content/Context;Ljava/lang/String;JZ)[Ljava/net/InetAddress;
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcn/jiguang/by/b;->a(Ljava/lang/String;)Ljava/net/InetAddress;
    ...
    :cond_1
    iget-wide v5, p0, Lcn/jiguang/by/b;->c:J

    iget-wide v7, p0, Lcn/jiguang/by/b;->d:J
    ...
    invoke-direct/range {v2 .. v8}, Lcn/jiguang/by/b;->a(Landroid/content/Context;Ljava/lang/String;JJ)Landroid/util/Pair;
    ...
    new-instance p4, Lcn/jiguang/by/b$a;

    invoke-direct {p4, p1, p2, p0}, Lcn/jiguang/by/b$a;-><init>(Landroid/content/Context;Ljava/lang/String;Lcn/jiguang/by/b;)V

    invoke-direct {p3, p4}, Ljava/util/concurrent/FutureTask;-><init>(Ljava/util/concurrent/Callable;)V

    new-array p1, v2, [I

    invoke-static {p3, p1}, Lcn/jiguang/bt/b;->c(Ljava/lang/Runnable;[I)V
    ...
    new-instance v0, Lcn/jiguang/by/b$a;

    invoke-direct {v0, p1, p2, p0}, Lcn/jiguang/by/b$a;-><init>(Landroid/content/Context;Ljava/lang/String;Lcn/jiguang/by/b;)V

    invoke-direct {p5, v0}, Ljava/util/concurrent/FutureTask;-><init>(Ljava/util/concurrent/Callable;)V

    new-array p1, v2, [I

    invoke-static {p5, p1}, Lcn/jiguang/bt/b;->c(Ljava/lang/Runnable;[I)V
