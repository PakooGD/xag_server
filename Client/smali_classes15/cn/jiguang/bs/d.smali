...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/jiguang/bs/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lcn/jiguang/bs/d;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0}, Lcn/jiguang/bs/d;->e(Landroid/content/Context;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;Ljava/lang/String;Lorg/json/JSONObject;Z)Ljava/io/File;
    ...
    .line 2
    invoke-static {p0, p1}, Lcn/jiguang/bs/d;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;

    move-result-object p0

    if-eqz p3, :cond_0

    invoke-static {p0}, Lcn/jiguang/bs/d;->b(Ljava/io/File;)V
...
.method public static a()Ljava/io/FileFilter;
    ...
    .line 3
    new-instance v0, Lcn/jiguang/bs/d$1;

    invoke-direct {v0}, Lcn/jiguang/bs/d$1;-><init>()V
...
.method public static a(Landroid/content/Context;)V
    ...
    invoke-direct {v0, v3, v1, v2, v1}, Lcn/jiguang/f/c$a;-><init>(ZZLjava/lang/String;I)V
    ...
    invoke-static {}, Lcn/jiguang/bs/d;->a()Ljava/io/FileFilter;

    move-result-object v4

    const/4 v5, 0x2

    new-array v5, v5, [Ljava/io/FileFilter;

    aput-object v0, v5, v3

    aput-object v4, v5, v1

    invoke-static {p0, v5}, Lcn/jiguang/f/c;->a(Ljava/io/File;[Ljava/io/FileFilter;)[Ljava/io/File;
    ...
    invoke-static {v5}, Lcn/jiguang/f/c;->e(Ljava/io/File;)V
    ...
    const-string v5, "updateByAppKey"
...
.method private static a(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {v3, p0}, Lcn/jiguang/bq/d;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v2}, Lcn/jiguang/f/c;->a(Ljava/io/File;[Ljava/io/FileFilter;)[Ljava/io/File;
    ...
    sget-object v8, Lcn/jiguang/bs/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    const-string v1, "process space="

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-static {p1}, Lcn/jiguang/bs/d;->e(Ljava/io/File;)Ljava/lang/String;
    ...
    new-instance p1, Lcn/jiguang/bs/d$4;

    invoke-direct {p1}, Lcn/jiguang/bs/d$4;-><init>()V
    ...
    :try_start_0
    invoke-static {v0}, Lcn/jiguang/bs/c;->a(Ljava/io/File;)Lorg/json/JSONObject;
    ...
    :cond_6
    invoke-static {v0}, Lcn/jiguang/bs/d;->b(Ljava/io/File;)V

    invoke-static {v1}, Lcn/jiguang/bs/f;->a(Lorg/json/JSONObject;)Ljava/util/Set;
    ...
    invoke-static {p0, v2, v1, v0, v4}, Lcn/jiguang/bs/f;->a(Landroid/content/Context;Ljava/util/Set;Lorg/json/JSONObject;Ljava/io/File;Lcn/jiguang/api/ReportCallBack;)I
...
.method public static a(Ljava/io/File;)V
    ...
    sget-object v0, Lcn/jiguang/bs/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b(Landroid/content/Context;)V
    ...
    .line 2
    sget-object v0, Lcn/jiguang/bs/d;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0, v0}, Lcn/jiguang/bq/d;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v0, Lcn/jiguang/bs/d$2;

    invoke-direct {v0, v1, p0}, Lcn/jiguang/bs/d$2;-><init>(Ljava/lang/String;Landroid/content/Context;)V
    ...
    :cond_1
    new-instance v0, Lcn/jiguang/bs/d$3;

    invoke-direct {v0, v1, p0}, Lcn/jiguang/bs/d$3;-><init>(Ljava/lang/String;Landroid/content/Context;)V
...
.method private static b(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {p1, p0}, Lcn/jiguang/bs/c;->a(Ljava/io/File;Lorg/json/JSONObject;)Lcn/jiguang/bs/c;
    ...
    invoke-static {v4, p0}, Lcn/jiguang/bs/c;->a(Ljava/io/File;Lorg/json/JSONObject;)Lcn/jiguang/bs/c;
    ...
    :cond_3
    invoke-virtual {p1, v4, v3}, Lcn/jiguang/bs/c;->a(Lcn/jiguang/bs/c;Ljava/io/File;)Z
    ...
    invoke-virtual {p1, p0, v3}, Lcn/jiguang/bs/c;->a(Lcn/jiguang/bs/c;Ljava/io/File;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic c(Landroid/content/Context;)V
    ...
    .line 1
    invoke-static {p0}, Lcn/jiguang/bs/d;->f(Landroid/content/Context;)V
...
.method private static c(Landroid/content/Context;Ljava/io/File;)V
    ...
    invoke-static {p0, p1}, Lcn/jiguang/bs/d;->b(Landroid/content/Context;Ljava/io/File;)V

    invoke-static {p1}, Lcn/jiguang/bs/d;->d(Ljava/io/File;)V

    invoke-static {p0, p1}, Lcn/jiguang/bs/d;->a(Landroid/content/Context;Ljava/io/File;)V

    invoke-static {p1}, Lcn/jiguang/bs/d;->c(Ljava/io/File;)V
...
.method private static c(Ljava/io/File;)V
    ...
    new-instance v2, Lcn/jiguang/bs/d$5;

    invoke-direct {v2}, Lcn/jiguang/bs/d$5;-><init>()V
    ...
    invoke-static {p0}, Lcn/jiguang/bs/d;->e(Ljava/io/File;)Ljava/lang/String;
...
.method private static declared-synchronized d(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 1
    const-class v0, Lcn/jiguang/bs/d;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcn/jiguang/bs/d;->b:Ljava/lang/String;
    ...
    sget-object p0, Lcn/jiguang/bs/d;->b:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    sget-object v1, Lcn/jiguang/bs/d;->a:Ljava/lang/String;
    ...
    :goto_0
    sput-object v1, Lcn/jiguang/bs/d;->a:Ljava/lang/String;
    ...
    sget-object v2, Lcn/jiguang/bs/d;->a:Ljava/lang/String;
    ...
    sput-object p0, Lcn/jiguang/bs/d;->b:Ljava/lang/String;
    :try_end_1
...
.method private static d(Ljava/io/File;)V
    ...
    sget-object v9, Lcn/jiguang/bs/d;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {}, Lcn/jiguang/bs/d;->b()Ljava/util/Set;
    ...
    invoke-static {v2, v1}, Lcn/jiguang/bs/c;->a(Ljava/io/File;Ljava/util/Set;)Lcn/jiguang/bs/c;

    move-result-object v2

    if-eqz v2, :cond_4

    iget-object v5, v2, Lcn/jiguang/bs/c;->b:Lorg/json/JSONObject;
    ...
    invoke-static {v3, v1}, Lcn/jiguang/bs/c;->a(Ljava/io/File;Ljava/util/Set;)Lcn/jiguang/bs/c;
    ...
    :cond_6
    iget-object v5, v3, Lcn/jiguang/bs/c;->b:Lorg/json/JSONObject;
    ...
    check-cast v6, Lcn/jiguang/bs/c;
    ...
    :cond_7
    invoke-virtual {v6, v3, p0}, Lcn/jiguang/bs/c;->a(Lcn/jiguang/bs/c;Ljava/io/File;)Z
    ...
    check-cast v2, Lcn/jiguang/bs/c;

    const/4 v3, 0x0

    invoke-virtual {v2, v3, p0}, Lcn/jiguang/bs/c;->a(Lcn/jiguang/bs/c;Ljava/io/File;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static e(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcn/jiguang/bs/d;->d(Landroid/content/Context;)Ljava/lang/String;
...
.method private static f(Landroid/content/Context;)V
    ...
    :try_start_0
    sget-object v2, Lcn/jiguang/bs/d;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0, v5}, Lcn/jiguang/bs/d;->c(Landroid/content/Context;Ljava/io/File;)V
    ...
    :cond_1
    :goto_1
    sget-object p0, Lcn/jiguang/bs/d;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
