...
.method public static a(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    :goto_1
    invoke-static {p0}, Lcn/jiguang/ae/a;->b(Landroid/content/Context;)Ljava/lang/Object;
    ...
    new-instance v1, Lcn/jiguang/ae/b$a;

    invoke-direct {v1, p0, p1}, Lcn/jiguang/ae/b$a;-><init>(Landroid/content/Context;Lorg/json/JSONObject;)V
...
.method public static synthetic b(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, p1}, Lcn/jiguang/ae/b;->c(Landroid/content/Context;Lorg/json/JSONObject;)V
...
.method private static c(Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    invoke-static {p0, v3}, Lcn/jiguang/aj/c;->e(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7}, Lcn/jiguang/y/a;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v8, Lcn/jiguang/af/c;

    invoke-direct {v8}, Lcn/jiguang/af/c;-><init>()V

    iput-object v6, v8, Lcn/jiguang/af/c;->a:Ljava/lang/String;

    iput-object p1, v8, Lcn/jiguang/af/c;->b:Ljava/lang/String;

    iget v7, v7, Landroid/content/pm/ApplicationInfo;->targetSdkVersion:I

    iput v7, v8, Lcn/jiguang/af/c;->c:I

    iput v5, v8, Lcn/jiguang/af/c;->i:I

    const/4 v5, 0x4

    iput v5, v8, Lcn/jiguang/af/c;->g:I
    ...
    :cond_0
    :goto_1
    invoke-static {v3, v6, p1, v4}, Lcn/jiguang/ag/d;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, Lcn/jiguang/ag/c;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, p1}, Lcn/jiguang/aq/e;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lcn/jiguang/ag/c;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object p1

    invoke-static {p0, p1}, Lcn/jiguang/ag/c;->a(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lcn/jiguang/ae/a;->a(Landroid/content/Context;Ljava/util/List;)Ljava/util/List;
