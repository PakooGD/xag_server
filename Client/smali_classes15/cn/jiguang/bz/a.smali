...
.method public static a(Landroid/content/Context;[BLjava/lang/String;)Landroid/util/Pair;
    ...
    new-instance v5, Lcn/jiguang/bz/c;

    invoke-direct {v5, v4, v0}, Lcn/jiguang/bz/c;-><init>(Z[B)V
    ...
    invoke-virtual {v5}, Lcn/jiguang/bz/c;->toString()Ljava/lang/String;
    ...
    iget v0, v5, Lcn/jiguang/bz/c;->a:I
    ...
    invoke-static {v2, v6}, Lcn/jiguang/bq/d;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-byte p1, v5, Lcn/jiguang/bz/c;->d:B

    const/4 v0, 0x2

    if-ne p1, v0, :cond_3

    new-instance p1, Lcn/jiguang/cm/e;

    invoke-direct {p1}, Lcn/jiguang/cm/e;-><init>()V

    invoke-virtual {p1, p0, p2}, Lcn/jiguang/cm/e;->b([BLjava/lang/String;)[B
    ...
    invoke-static {p0, p2, p1, v4}, Lcn/jiguang/cm/f;->a([BLjava/lang/String;Ljava/lang/String;Z)[B
...
.method public static a(Landroid/content/Context;[B)Z
    ...
    invoke-static {p0, p1, v1}, Lcn/jiguang/bz/a;->a(Landroid/content/Context;[BLjava/lang/String;)Landroid/util/Pair;
    ...
    iget-wide v4, v4, Lcn/jiguang/bz/c;->g:J
    ...
    invoke-virtual {p1, p0, v2, v1}, Lcn/jiguang/bx/b;->a(Landroid/content/Context;Lcn/jiguang/bz/c;Ljava/nio/ByteBuffer;)V
    :try_end_0
