...
.method public getPVCLocal()Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public declared-synchronized refreshSyncMap(Landroid/content/Context;)V
    ...
    const-string v1, "TbsBaseConfig"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "refreshSyncMap propFile is "
    ...
    :cond_1
    const-string p1, "TbsBaseConfig"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "refreshSyncMap pv mSyncMap is "
    ...
    const-string v2, "refreshSyncMap stack is "
    ...
    const-string v3, "refreshSyncMap stack is "
...
.method public declared-synchronized writeTbsDownloadInfo()V
    ...
    const-string v2, "TbsBaseConfig"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "writeTbsDownloadInfo propFile is "
    ...
    const-string v5, "TbsBaseConfig"

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "writeTbsDownloadInfo mSyncMap.size() is "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v7, p0, Lcom/tencent/smtt/sdk/TbsBaseConfig;->a:Ljava/util/Map;
    ...
    const-string v2, "writeTbsDownloadInfo end "
    ...
    const-string v4, "writeTbsDownloadInfo stack is "
    ...
    const-string v3, "writeTbsDownloadInfo stack is "
    ...
    :goto_4
    :try_start_9
    const-string v3, "TbsBaseConfig"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "writeTbsDownloadInfo stack is "
