...
.method private handlePreflight(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpRequest;)V
    ...
    .line 19
    invoke-virtual {v0, v4}, Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;->withCombiningHeaders(Z)Lio/netty/handler/codec/http/DefaultHttpHeadersFactory;
    ...
    .line 36
    .line 37
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setOrigin(Lio/netty/handler/codec/http/HttpResponse;)Z
    ...
    .line 42
    .line 43
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setAllowMethods(Lio/netty/handler/codec/http/HttpResponse;)V

    .line 44
    .line 45
    .line 46
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setAllowHeaders(Lio/netty/handler/codec/http/HttpResponse;)V

    .line 47
    .line 48
    .line 49
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setAllowCredentials(Lio/netty/handler/codec/http/HttpResponse;)V

    .line 50
    .line 51
    .line 52
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setMaxAge(Lio/netty/handler/codec/http/HttpResponse;)V

    .line 53
    .line 54
    .line 55
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setPreflightHeaders(Lio/netty/handler/codec/http/HttpResponse;)V

    .line 56
    .line 57
    .line 58
    invoke-direct {p0, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->setAllowPrivateNetwork(Lio/netty/handler/codec/http/HttpResponse;)V
    ...
    .line 84
    .line 85
    invoke-static {p1, p2, v6}, Lio/netty/handler/codec/http/cors/CorsHandler;->respond(Lio/netty/channel/ChannelHandlerContext;Lio/netty/handler/codec/http/HttpRequest;Lio/netty/handler/codec/http/HttpResponse;)V
